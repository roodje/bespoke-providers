...
@Configuration
public class AmexEuBeanConfig {

    private static final String PROVIDER_IDENTIFIER = "AMEX_EU";

    @Bean("AmexEuDataProviderV6")
    public AmexGroupDataProviderV6 getAmexEuDataProviderV6(AmexGroupConfigurationProperties properties,
