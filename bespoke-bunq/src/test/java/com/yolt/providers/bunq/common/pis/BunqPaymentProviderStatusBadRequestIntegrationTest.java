...
@AutoConfigureWireMock(stubs = "classpath:/mappings/pis/400-status-badrequest", httpsPort = 0, port = 0)
class BunqPaymentProviderStatusBadRequestIntegrationTest {
    ...
    void shouldReturnResponseWithErrorDetailsInRawPaymentStatusWhenBadRequestIsReceivedFromBank() {
        ...
        var getPaymentStatusRequest = new GetStatusRequestBuilder()
        ...
        assertThat(result.getPaymentExecutionContextMetadata())
                ...
                .satisfies(paymentStatuses -> {
                    ...
                    assertThat(paymentStatuses.getPaymentStatus()).isEqualTo(EnhancedPaymentStatus.UNKNOWN);
                });
    }
