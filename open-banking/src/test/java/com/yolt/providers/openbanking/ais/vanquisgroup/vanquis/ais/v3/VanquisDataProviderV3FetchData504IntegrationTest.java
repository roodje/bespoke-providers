...
/**
 * This test contains case when, according to documentation, request to accounts returns 504.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/vanquisgroup/ais/ob_3.1.1/accounts-504", httpsPort = 0, port = 0)
@ActiveProfiles("vanquisgroupV1")
public class VanquisDataProviderV3FetchData504IntegrationTest {
    ...
    public void shouldThrowProviderFetchDataExceptionWhenResponseStatusIs504(VanquisGroupBaseDataProviderV2 dataProvider) throws Exception {
        // given
