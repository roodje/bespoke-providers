...
/**
 * This test suite contains case where 403 error with banned ip information is returned from data endpoint in Virgin Money
 * provider. It means that getting data failed so we want to throw {@link ProviderFetchDataException})
 * Covered flows:
 * - fetching accounts
 * <p>
 */
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/virginmoney/ais/v3/error_403_ip_banned", httpsPort = 0, port = 0)
public class VirginMoneyDataProviderV5FetchData403IpBannedIntegrationTest {
    ...
    @Test
    public void shouldThrowProviderFetchDataExceptionWhenResponseStatusIs403WithInformationAboutIpBan() throws Exception {
        // given
    ...
    private UrlFetchDataRequest createUrlFetchDataRequest() throws JsonProcessingException {
        ...
        AccessMeans token = new AccessMeans(Instant.now(), USER_ID, "bannedIpAccessToken", "refreshToken",
