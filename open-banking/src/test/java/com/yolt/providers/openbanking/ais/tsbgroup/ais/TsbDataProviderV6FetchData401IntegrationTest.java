 ...
 * This means that request is unauthorized, thus we want to force user to fill a consent
 * (so throw {@link TokenInvalidException})
 * <p>
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/tsbgroup/ais/ob_3.1.1/accounts-401", httpsPort = 0, port = 0)
@ActiveProfiles("tsbgroup")
public class TsbDataProviderV6FetchData401IntegrationTest {
