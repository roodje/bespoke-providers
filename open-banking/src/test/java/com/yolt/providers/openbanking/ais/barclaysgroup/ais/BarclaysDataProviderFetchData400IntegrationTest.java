...
/**
 * According to our observations, sometimes we receive HTTP-400 from bank with the information about invalid consent.
 * In such scenario we want to force the user to re-consent (so we throw {@link TokenInvalidException}).
 * In case of any other HTTP-400 we behave the standard way.
 * <p>
 * Covered flows:
 * - fetching accounts
 * <p>
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/barclaysgroup/ais-3.1/v3/accounts-400", httpsPort = 0, port = 0)
@ActiveProfiles("barclays")
public class BarclaysDataProviderFetchData400IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionOnHttp400WithInvalidConsentMessage(UrlDataProvider subject) throws IOException, URISyntaxException {
        // given
        UrlFetchDataRequest urlFetchData = new UrlFetchDataRequestBuilder()
                ...
                .setRestTemplateManager(new RestTemplateManagerMock(() -> "d0a9b85f-9715-4d16-a33d-4323ceab5254"))
                .setSigner(SIGNER)
                .build();
    ...
    @ParameterizedTest
    @MethodSource("getProviders")
    public void shouldThrowProviderFetchDataExceptionOnHttp400WithoutInvalidConsentMessage(UrlDataProvider subject) throws IOException, URISyntaxException {
        // given
        UrlFetchDataRequest urlFetchData = new UrlFetchDataRequestBuilder()
                .setTransactionsFetchStartTime(Instant.now())
                .setAccessMeans(createAccessMeansDTO(SERIALIZED_ACCESS_MEANS))
                .setAuthenticationMeans(new BarclaysSampleTypedAuthenticationMeans().getAuthenticationMean())
                .setRestTemplateManager(new RestTemplateManagerMock(() -> "d0a9b85f-9715-4d16-a33d-4323ceab5255"))
                .setSigner(SIGNER)
                .build();
