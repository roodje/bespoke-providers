...
@AutoConfigureWireMock(stubs = "classpath:/stubs/capitalonegroup/ais-3.1.2/account-access-consents-delete-500", httpsPort = 0, port = 0)
@ActiveProfiles("capitalonegroup")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class CapitalOneDataProviderV3DeleteUserSite500IntegrationTest {
    ...
    void shouldDeleteUserSiteThrowHttpServerErrorExceptionWhenResponseStatusIs500(UrlDataProvider provider) {
        // given
