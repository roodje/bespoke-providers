...
/**
 * This test contains case according to documentation, when request to transactions returned 403.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/cybgroup/ais-3.1/transactions-403", httpsPort = 0, port = 0)
@ActiveProfiles("cybgroup")
public class CybgGroupDataProviderV3FetchData403IntegrationTest {
    ...
    void shouldThrowTokenInvalidExceptionWhenTransactionRequestFail(UrlDataProvider provider) throws JsonProcessingException {
        // given
