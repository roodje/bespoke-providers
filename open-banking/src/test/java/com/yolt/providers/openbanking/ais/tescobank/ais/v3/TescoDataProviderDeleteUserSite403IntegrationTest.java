...
@SpringBootTest(classes = {TescoBankApp.class, OpenbankingConfiguration.class},
        webEnvironment = SpringBootTest.WebEnvironment.NONE)
@AutoConfigureWireMock(stubs = "classpath:/stubs/tescobank/ais-3.1/account-access-consents-delete-403", httpsPort = 0, port = 0)
@ActiveProfiles("tescobank")
public class TescoDataProviderDeleteUserSite403IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenUnauthorizedCallToOnUserSiteDeleteIsMade(GenericBaseDataProviderV2 provider) throws IOException, URISyntaxException {
        // given
        ...
        // when
        ThrowableAssert.ThrowingCallable handler = () -> provider.onUserSiteDelete(urlGetLogin);
