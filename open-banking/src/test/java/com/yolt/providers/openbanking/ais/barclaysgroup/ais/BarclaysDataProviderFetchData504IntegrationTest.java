...
@AutoConfigureWireMock(stubs = "classpath:/stubs/barclaysgroup/ais-3.1/v3/accounts-504", httpsPort = 0, port = 0)
@ActiveProfiles("barclays")
public class BarclaysDataProviderFetchData504IntegrationTest {
    ...
    public void shouldThrowProviderFetchDataExceptionOn504(UrlDataProvider subject) throws IOException, URISyntaxException {
        // given
