...
@AutoConfigureWireMock(stubs = "classpath:/stubs/tidegroup/ob_3.1.1/ais/v2/accounts_401/", port = 0, httpsPort = 0)
public class TideGroupDataProviderV3Accounts401IntegrationTest {
