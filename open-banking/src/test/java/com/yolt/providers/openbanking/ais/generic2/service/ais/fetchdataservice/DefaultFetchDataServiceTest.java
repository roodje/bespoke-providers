...
public class DefaultFetchDataServiceTest {
    ...
    public void setup() throws IOException, URISyntaxException {
        ...
        fetchDataService = new DefaultFetchDataService(restClient, properties,
    ...
    public void shouldThrowProviderFetchDataExceptionWithSingleFailedAccountForGetAccountsAndTransactionsWhenSomethingWentWrong() throws JsonParseException, TokenInvalidException {
        ...
        // when
        ThrowableAssert.ThrowingCallable getAccountsAndTransactionsCallable = () -> fetchDataService.getAccountsAndTransactions(httpClient, authMeans, null, null);
