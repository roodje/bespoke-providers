...
public class LloydsGroupDataProviderUserSiteDelete404IntegrationTest {
    ...
    public void shouldOnUserSiteDeleteWhenHttp404ResponseThrowsNoException(UrlDataProvider dataProvider) throws TokenInvalidException {
        // given
        requestTraceId = "40400000-8cea-412d-b6ed-04aeb924eace";
