...
@ActiveProfiles("aib")
@AutoConfigureWireMock(stubs = "classpath:/stubs/aibgroup/v31/client_secret/invalid-refresh-token/", httpsPort = 0, port = 0)
public class AibGroupDataProviderRefreshTokenWithInvalidTokenIntegrationTest {
    ...
    void shouldThrowInvalidTokenExceptionWhenRefreshingTokenWithInvalidRefreshToken(GenericBaseDataProvider aibDataProvider) throws Exception {
        // given
