 ...
 * This means that request there was internal server error, thus we can't map such account
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/tsbgroup/ais/ob_3.1.1/accounts-504", httpsPort = 0, port = 0)
@ActiveProfiles("tsbgroup")
public class TsbDataProviderV6FetchData504IntegrationTest {
