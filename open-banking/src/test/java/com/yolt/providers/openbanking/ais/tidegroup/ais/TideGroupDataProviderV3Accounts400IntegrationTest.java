...
@AutoConfigureWireMock(stubs = "classpath:/stubs/tidegroup/ob_3.1.1/ais/v2/accounts_400/", port = 0, httpsPort = 0)
public class TideGroupDataProviderV3Accounts400IntegrationTest {
    ...
    void shouldThrowTokenInvalidExceptionWhenRevokedConsent(TideGroupDataProviderV2 subject) throws Exception {
        // given
