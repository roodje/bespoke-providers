 ...
 * <p>
 * Disclaimer: Bank of Ireland is a single bank, so there is no need to parametrize this test class.
 * <p>
 * Covered flows:
 * - fetching accounts
 * <p>
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/bankofireland/ais-3.0.0/accounts-504", httpsPort = 0, port = 0)
@ActiveProfiles("bankofireland")
public class BankOfIrelandGroupDataProviderFetchData504IntegrationTest {
    ...
    public void shouldThrowProviderFetchDataExceptionOn504(BankOfIrelandGroupBaseDataProvider subject, Map<String, BasicAuthenticationMean> authenticationMeans) {
        // given
