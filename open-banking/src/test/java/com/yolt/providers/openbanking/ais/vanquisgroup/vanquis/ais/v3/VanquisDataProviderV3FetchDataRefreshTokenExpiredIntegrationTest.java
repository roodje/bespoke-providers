...
/**
 * This test contains case when refresh token is expired.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/vanquisgroup/ais/ob_3.1.1/token-expired", httpsPort = 0, port = 0)
@ActiveProfiles("vanquisgroupV1")
public class VanquisDataProviderV3FetchDataRefreshTokenExpiredIntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenRefreshTokenIsExpired(VanquisGroupBaseDataProviderV2 dataProvider) throws Exception {
        // given
