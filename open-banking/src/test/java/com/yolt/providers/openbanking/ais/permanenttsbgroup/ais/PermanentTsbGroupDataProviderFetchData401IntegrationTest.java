...
/**
 * This test suite contains case where 401 error is returned from data endpoint in Permanent TSB group providers.
 * <p>
...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/permanenttsbgroup/ais-3.1/accounts-401"}, httpsPort = 0, port = 0)
public class PermanentTsbGroupDataProviderFetchData401IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenResponseStatusIs401(UrlDataProvider dataProvider) throws Exception {
        // given
