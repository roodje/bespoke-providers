...
public class TsbDataProviderV6RefreshAccessMeansTokenIsNullIntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenRefreshTokenIsNull(UrlDataProvider dataProvider) throws Exception {
        // given
