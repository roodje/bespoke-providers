...
public class DefaultAuthServiceOauth2TlsIntegrationTest {
    ...
    public void setup() throws IOException, URISyntaxException {
        restTemplateManagerMock = new RestTemplateManagerMock(() -> "6546456");
        oauth2Client = new DefaultMutualTlsOauth2Client(properties, false);
