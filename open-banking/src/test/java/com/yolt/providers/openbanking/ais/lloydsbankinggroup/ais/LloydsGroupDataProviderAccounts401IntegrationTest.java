...
@AutoConfigureWireMock(stubs = "classpath:/stubs/lloydsbankinggroup/ais/accounts-401/", httpsPort = 0, port = 0)
public class LloydsGroupDataProviderAccounts401IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenResponseStatusIs401(UrlDataProvider dataProvider) throws Exception {
        ...
        // given
        requestTraceId = "40100000-8cea-412d-b6ed-04aeb924eace";
