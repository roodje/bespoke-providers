...
@Deprecated
class HsbcGroupPaymentProviderV13RejectedPaymentsIntegrationTest {
    ...
    public void shouldReturnInitiationErrorStatusWhenInvalidUkDomesticPaymentToBeRejected(GenericBasePaymentProviderV2 paymentProvider) {
        // given
    ...
    @ParameterizedTest
    @MethodSource("getPaymentDataProviders")
    public void shouldThrowPaymentExecutionTechnicalExceptionWhenRemittanceInformationHasIllegalCharacters(GenericBasePaymentProviderV2 paymentProvider) {
        // given
    ...
    @ParameterizedTest
    @MethodSource("getPaymentDataProviders")
    public void shouldReturnUnknownStatusWhenSubmitInvalidUkDomesticPayment(GenericBasePaymentProviderV2 paymentProvider) {
        // given
