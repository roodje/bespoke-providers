...
/**
 * This test contains fetch data flow when errors occur on optional endpoints in CYBG group providers.
 * <p>
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/cybgroup/ais-3.1/error-on-optional-endpoints", httpsPort = 0, port = 0)
@ActiveProfiles("cybgroup")
public class CybgGroupDataProviderV3FetchDataErrorOnOptionalEndpointsIntegrationTest {
    ...
    void shouldNotThrowExceptionWhenErrorOccursOnOptionalEndpoints(UrlDataProvider provider) throws JsonProcessingException, TokenInvalidException, ProviderFetchDataException {
        // given
