...
/**
 * This test suite contains case where 401 error is returned from data endpoint in Virgin Money provider.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/virginmoney/ais/v3/error_401", httpsPort = 0, port = 0)
public class VirginMoneyDataProviderV5FetchData401IntegrationTest {
