...
class AibGroupPaymentRequestValidatorTest {
    ...
    private AibGroupPaymentRequestValidator subject = new AibGroupPaymentRequestValidator();
    ...
    private static Stream<Arguments> getDtoAndExpectedResult() {
        return Stream.of(
                ...
                Arguments.of(prepareDataInitiation(false,
                        ...
                        "reference",
                        "unstructured",
                        "END123"), "Creditor name, account scheme(SortCodeAccountNumber) and number are required"));
    }
