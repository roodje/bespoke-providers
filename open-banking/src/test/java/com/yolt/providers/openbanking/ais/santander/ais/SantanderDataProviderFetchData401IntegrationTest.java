...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/santander/ais-3.1.6/accounts-401"}, httpsPort = 0, port = 0)
public class SantanderDataProviderFetchData401IntegrationTest {
    ...
    void shouldThrowTokenInvalidException(UrlDataProvider provider) {
        // given
