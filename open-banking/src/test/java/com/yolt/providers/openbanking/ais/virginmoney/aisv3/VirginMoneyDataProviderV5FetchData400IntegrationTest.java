...
/**
 * This test suite contains case where 400 error is returned from data endpoint in Virgin Money provider.
 * This could happen when a user does not complete the journey or cancels it midway through. Re-authenticating the PSU
 * is unlikely to remediate the situation (so throw {@link TokenInvalidException})
 * Covered flows:
 * - fetching accounts
 * <p>
 */
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/virginmoney/ais/v3/error_400", httpsPort = 0, port = 0)
public class VirginMoneyDataProviderV5FetchData400IntegrationTest {
    ...
    @Test
    public void shouldThrowTokenInvalidExceptionWhenResponseStatusIs400AndBodyContainsInvalidConsent() throws Exception {
        // given
