 ...
 * TODO: The associated stub file doesn't contain RDD based HTTP 403 response body. The stub content should be updated when such RDD data found.
 */
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/revolut/ais-3.1.0/accounts-403", httpsPort = 0, port = 0)
public class RevolutDataProviderFetchData403IntegrationTest {
    ...
    public void shouldThrowTokenInvalidException(UrlDataProvider dataProvider) throws Exception {
        // given
