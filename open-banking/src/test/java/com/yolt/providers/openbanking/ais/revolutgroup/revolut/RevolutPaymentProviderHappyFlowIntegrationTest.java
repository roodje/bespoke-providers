package com.yolt.providers.openbanking.ais.revolutgroup.revolut;
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/revolut/pis-3.1.0/uk/happy-flow", httpsPort = 0, port = 0)
public class RevolutPaymentProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    @Qualifier("RevolutPaymentProviderV1")
    private GenericBasePaymentProviderV3 revolutGbPaymentProviderV1;

    private Stream<GenericBasePaymentProviderV3> getProviders() {
        return Stream.of(revolutGbPaymentProviderV1);
    }
    ...
    public void shouldCreateDomesticPayment(GenericBasePaymentProviderV3 subject) throws JsonProcessingException {
        ...
        assertThat(state).extracting(UkProviderState::getConsentId, UkProviderState::getPaymentType, UkProviderState::getOpenBankingPayment).
                contains("58923", PaymentType.SINGLE, """
                        {"InstructionIdentification":"20201202002028103-4b1t742n-102","EndToEndIdentification":"B7F2761C","InstructedAmount":{"Amount":"10000.00","Currency":"GBP"},"CreditorAccount":{"SchemeName":"UK.OBIE.SortCodeAccountNumber","Identification":"98765432104322","Name":"ACME Inc creditor"},"RemittanceInformation":{"Unstructured":"Remittance Unstructured","Reference":"REF0123456789-0123"}}""");
    ...
    public void shouldSubmitDomesticPayment(GenericBasePaymentProviderV3 subject) throws JsonProcessingException {
        ...
        String providerState = """
                {"consentId":"58923","paymentType":"SINGLE","openBankingPayment":"{\\"InstructionIdentification\\":\\"20200515101750462-522347ee-5e0\\",\\"EndToEndIdentification\\":\\"B7F2761C\\",\\"InstructedAmount\\":{\\"Amount\\":\\"10000.00\\",\\"Currency\\":\\"GBP\\"},\\"CreditorAccount\\":{\\"SchemeName\\":\\"UK.OBIE.SortCodeAccountNumber\\",\\"Identification\\":\\"98765432104322\\",\\"Name\\":\\"ACME Inc creditor\\"},\\"RemittanceInformation\\":{\\"Unstructured\\":\\"Remittance Unstructured\\",\\"Reference\\":\\"REF0123456789-0123\\"}}"}""";
