...
@AutoConfigureWireMock(stubs = "classpath:/stubs/barclaysgroup/ais-3.1/v3/accounts-403", httpsPort = 0, port = 0)
@ActiveProfiles("barclays")
public class BarclaysDataProviderFetchData403IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionOn403(UrlDataProvider subject) throws IOException, URISyntaxException {
        // given
