...
@AutoConfigureWireMock(stubs = "classpath:/stubs/revolut/ais-3.1.0/accounts-400", httpsPort = 0, port = 0)
public class RevolutDataProviderFetchData400IntegrationTest {
