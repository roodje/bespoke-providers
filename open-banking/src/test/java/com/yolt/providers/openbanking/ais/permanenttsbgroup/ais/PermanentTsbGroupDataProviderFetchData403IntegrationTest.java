...
/**
 * This test suite contains case where 403 error is returned from data endpoint in Permanent TSB group providers.
 * <p>
...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/permanenttsbgroup/ais-3.1/accounts-403"}, httpsPort = 0, port = 0)
public class PermanentTsbGroupDataProviderFetchData403IntegrationTest {
