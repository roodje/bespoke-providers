...
/**
 * This test contains case when, according to documentation, request to accounts returns 403.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/vanquisgroup/ais/ob_3.1.1/accounts-403", httpsPort = 0, port = 0)
@ActiveProfiles("vanquisgroupV1")
public class VanquisDataProviderV3FetchData403IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenResponseStatusIs403(VanquisGroupBaseDataProviderV2 dataProvider) throws Exception {
        // From specs:
        // 403 Forbidden
