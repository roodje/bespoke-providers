...
@AutoConfigureWireMock(stubs = "classpath:/stubs/lloydsbankinggroup/ais/accounts-400/", httpsPort = 0, port = 0)
public class LloydsGroupDataProviderAccounts400IntegrationTest {
    ...
    private String requestTraceId = "40000000-8cea-412d-b6ed-04aeb924eace";
