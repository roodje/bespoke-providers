...
/**
 * This tests covers the handling for HTTP-500 INTERNAL_SERVER_ERROR response on the accounts endpoint
 */
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/newdaygroup/ais-3.1/accounts-500/", httpsPort = 0, port = 0)
public class NewDayGroupDataProviderV3FetchData500IntegrationTest {
    ...
    public void shouldThrowProviderFetchDataExceptionOnHttp500(UrlDataProvider dataProvider) throws Exception {
        // given
