...
/**
 * This tests covers the handling for HTTP-403 FORBIDDEN response on the accounts endpoint
 */
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/newdaygroup/ais-3.1/accounts-403/", httpsPort = 0, port = 0)
public class NewDayGroupDataProviderV3FetchData403IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionOnHttp403(UrlDataProvider dataProvider) {
        // given
