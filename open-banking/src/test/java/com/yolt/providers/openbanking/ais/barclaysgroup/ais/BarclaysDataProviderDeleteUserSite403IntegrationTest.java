...
/**
 * This test contains case according to documentation, when request to remove consent on bank side fails, because this
 * source is not available (consent already removed). We don't want to try again and again, so no error should be thrown.
 * <p>
 * Covered flows:
...
@SpringBootTest(classes = {BarclaysApp.class, OpenbankingConfiguration.class},
        webEnvironment = SpringBootTest.WebEnvironment.NONE)
@AutoConfigureWireMock(stubs = "classpath:/stubs/barclaysgroup/ais-3.1/v3/account-access-consents-delete-403", httpsPort = 0, port = 0)
@ActiveProfiles("barclays")
public class BarclaysDataProviderDeleteUserSite403IntegrationTest {
    ...
    public void shouldDeleteUserSiteThrowNoExceptionWhenResponseStatusIs403(UrlDataProvider subject) throws IOException, URISyntaxException {
        // given
