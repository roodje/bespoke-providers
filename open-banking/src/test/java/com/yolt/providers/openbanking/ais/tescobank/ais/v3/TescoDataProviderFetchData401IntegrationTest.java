...
@AutoConfigureWireMock(stubs = "classpath:/stubs/tescobank/ais-3.1/accounts-401", httpsPort = 0, port = 0)
@ActiveProfiles("tescobank")
public class TescoDataProviderFetchData401IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionOn401(GenericBaseDataProviderV2 provider) throws IOException, URISyntaxException {
        // given
