...
public class NationwideDataProviderRefreshAccessMeansExpiredRefreshTokenIntegrationTestIntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenRefreshTokenIsExpired(UrlDataProvider provider) throws Exception {
        // given
