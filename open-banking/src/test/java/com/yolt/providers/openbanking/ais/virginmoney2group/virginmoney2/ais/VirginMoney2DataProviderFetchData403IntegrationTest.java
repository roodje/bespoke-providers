...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/virginmoney2group/virginmoney2/ais/v3.1.2/fetch-data_403",
        "classpath:/stubs/virginmoney2group/virginmoney2/oauth2/v3.0/happy-flow"},
        httpsPort = 0,
        port = 0)
public class VirginMoney2DataProviderFetchData403IntegrationTest {
    ...
    @Test
    void shouldThrowTokenInvalidExceptionWhen403ResponseIsReceivedFromBankApi() throws IOException, URISyntaxException {
        // given
