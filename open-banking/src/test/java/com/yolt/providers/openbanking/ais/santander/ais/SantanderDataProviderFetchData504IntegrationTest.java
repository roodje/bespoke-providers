...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/santander/ais-3.1.6/accounts-504"}, httpsPort = 0, port = 0)
public class SantanderDataProviderFetchData504IntegrationTest {
