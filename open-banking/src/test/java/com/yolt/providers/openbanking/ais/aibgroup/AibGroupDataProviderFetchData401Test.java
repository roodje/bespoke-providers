...
@ActiveProfiles("aib")
@AutoConfigureWireMock(stubs = "classpath:/stubs/aibgroup/v31/client_secret/accounts-401/", httpsPort = 0, port = 0)
public class AibGroupDataProviderFetchData401Test {
    ...
    void shouldThrowTokenInvalidExceptionIfFetchingDataWouldReturn401Error(GenericBaseDataProvider dataProvider) {
        // given
