...
@AutoConfigureWireMock(stubs = "classpath:/stubs/revolut/pis-3.1.0/uk/unhappy-flow", httpsPort = 0, port = 0)
public class RevolutPaymentProviderUnhappyPaymentsIntegrationTest {
    ...
    void shouldReturnCorrectPECMetadataWhenPaymentSubmissionFailsDueToClientError(GenericBasePaymentProviderV3 subject) {
        // given
        String providerState = """
                {"consentId":"58926","paymentType":"SINGLE","openBankingPayment":"{\\"InstructionIdentification\\":\\"20200515101750462-522347ee-5e0\\",\\"EndToEndIdentification\\":\\"B7F2761C400\\",\\"InstructedAmount\\":{\\"Amount\\":\\"10000.00\\",\\"Currency\\":\\"GBP\\"},\\"CreditorAccount\\":{\\"SchemeName\\":\\"UK.OBIE.SortCodeAccountNumber\\",\\"Identification\\":\\"98765432104322\\",\\"Name\\":\\"ACME Inc creditor\\"},\\"RemittanceInformation\\":{\\"Unstructured\\":\\"Remittance Unstructured\\",\\"Reference\\":\\"REF0123456789-0123\\"}}"}""";
        SubmitPaymentRequest confirmPaymentRequest = createUkDomesticSubmitPaymentRequest(providerState);
