...
@Deprecated
        //old version
class HsbcGroupUkDomesticPaymentV13ProviderIntegrationTest {
    ...
    private Stream<GenericBasePaymentProviderV2> getProviders() {
        return Stream.of(hsbcPaymentProviderV13,
    ...
    private GetStatusRequest creteUkDomesticGetStatusRequest(boolean withPaymentId) {
        return new GetStatusRequest(withPaymentId ? null : createUkProviderState(new UkProviderState("331d76df48ed41229b67f062dd55e340", PaymentType.SINGLE, "")),
