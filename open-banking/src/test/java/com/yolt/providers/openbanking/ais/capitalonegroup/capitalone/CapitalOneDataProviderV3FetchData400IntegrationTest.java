...
@AutoConfigureWireMock(stubs = "classpath:/stubs/capitalonegroup/ais-3.1.2/accounts-400", httpsPort = 0, port = 0)
@ActiveProfiles("capitalonegroup")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class CapitalOneDataProviderV3FetchData400IntegrationTest {
    ...
    public void shouldThrowProviderFetchDataExceptionWhenAccountsRequestFail(UrlDataProvider provider) {
        // given
