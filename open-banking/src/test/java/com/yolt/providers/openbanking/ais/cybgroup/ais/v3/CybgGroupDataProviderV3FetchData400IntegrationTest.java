...
/**
 * This test contains case according to documentation, when request acquiring balances fail due to 400.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/cybgroup/ais-3.1/transactions-400", httpsPort = 0, port = 0)
@ActiveProfiles("cybgroup")
public class CybgGroupDataProviderV3FetchData400IntegrationTest {
    ...
    void shouldThrowProviderFetchDataExceptionWhenBalancesRequestFail(UrlDataProvider provider) throws JsonProcessingException {
        // given
