...
@AutoConfigureWireMock(stubs = "classpath:/stubs/bankofireland/ais-3.0.0/accounts-403", httpsPort = 0, port = 0)
@ActiveProfiles("bankofireland")
public class BankOfIrelandGroupDataProviderFetchData403IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionOn403(BankOfIrelandGroupBaseDataProvider subject, Map<String, BasicAuthenticationMean> authenticationMeans) {
        // given
