...
/**
 * This test suite contains case when 504 error is returned from data endpoint in Virgin Money provider. It means that
 * getting data failed so we want to throw {@link ProviderFetchDataException})
 * Covered flows:
 * - fetching accounts
 * <p>
 */
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/virginmoney/ais/v3/error_504", httpsPort = 0, port = 0)
public class VirginMoneyDataProviderV5FetchData504IntegrationTest {
    ...
    @Test
    public void shouldThrowProviderFetchDataExceptionWhenResponseStatusIs504UserSiteStatusIsRefreshFailed() throws Exception {
        // given
