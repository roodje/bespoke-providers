...
/**
 * This test contains case according to documentation, when request acquiring accounts fail due to 504.
 * This means that request there was timeout error, thus we can't map such account (so throw {@link ProviderFetchDataException})
 * <p>
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/lloydsbankinggroup/ais/accounts-504/", httpsPort = 0, port = 0)
public class LloydsGroupDataProviderAccounts504IntegrationTest {
    ...
    private String requestTraceId = "50400000-8cea-412d-b6ed-04aeb924eace";
    ...
    public void shouldThrowProviderFetchDataExceptionWhenResponseStatusIs504(UrlDataProvider dataProvider) throws Exception {
        // given
