...
@AutoConfigureWireMock(stubs = "classpath:/stubs/sainsburys/ais-3.1.1/accounts-401", httpsPort = 0, port = 0)
@ActiveProfiles("sainsburys")
public class SainsburysDataProviderV2FetchData401IntegrationTest {
    ...
    @Test
    public void shouldThrowTokenInvalidExceptionWhenResponseStatusIs401() throws Exception {
        // given
