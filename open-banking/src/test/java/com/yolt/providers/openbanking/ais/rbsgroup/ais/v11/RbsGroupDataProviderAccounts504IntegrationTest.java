 ...
 * This means that there are some server issue on bank side, thus we <b>DON't</b> want to force user to fill a consent (so throw {@link ProviderFetchDataException})
 * <p>
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/rbsgroup/ob_3.1.6/ais/accounts_504/", port = 0, httpsPort = 0)
class RbsGroupDataProviderAccounts504IntegrationTest {
    ...
    void shouldThrowExceptionWhenAccountsRequestFail(RbsGroupDataProviderV5 dataProvider) throws Exception {
        // given
