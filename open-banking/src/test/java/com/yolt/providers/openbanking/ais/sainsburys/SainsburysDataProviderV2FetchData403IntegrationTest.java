 ...
 * This means that access for requested data is forbidden, thus we want to force user to fill a consent
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/sainsburys/ais-3.1.1/accounts-403", httpsPort = 0, port = 0)
@ActiveProfiles("sainsburys")
public class SainsburysDataProviderV2FetchData403IntegrationTest {
