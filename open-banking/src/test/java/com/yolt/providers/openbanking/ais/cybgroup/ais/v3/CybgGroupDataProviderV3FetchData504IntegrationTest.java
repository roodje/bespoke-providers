...
/**
 * This test contains case according to documentation, when request to balances returned 504.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/cybgroup/ais-3.1/transactions-504", httpsPort = 0, port = 0)
@ActiveProfiles("cybgroup")
public class CybgGroupDataProviderV3FetchData504IntegrationTest {
