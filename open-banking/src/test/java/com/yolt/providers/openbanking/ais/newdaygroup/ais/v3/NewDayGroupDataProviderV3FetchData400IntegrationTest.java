...
/**
 * This tests covers the handling for HTTP-400 BAD_REQUEST response on the accounts endpoint
 */
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/newdaygroup/ais-3.1/accounts-400/", httpsPort = 0, port = 0)
public class NewDayGroupDataProviderV3FetchData400IntegrationTest {
    ...
    public void shouldThrowProviderFetchDataExceptionOnHttp400(UrlDataProvider dataProvider) throws Exception {
        // given
