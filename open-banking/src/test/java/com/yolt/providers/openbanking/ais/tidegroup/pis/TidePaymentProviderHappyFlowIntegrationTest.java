package com.yolt.providers.openbanking.ais.tidegroup.pis;
...
import static com.yolt.providers.openbanking.ais.generic2.pec.mapper.datainitiation.PaymentDataInitiationMapper.REMITTANCE_INFORMATION_STRUCTURED_FIELD_NAME;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.boot.test.context.SpringBootTest.WebEnvironment.NONE;

@SpringBootTest(classes = {TideGroupApp.class, TestConfiguration.class, OpenbankingConfiguration.class}, webEnvironment = NONE)
@ActiveProfiles("tidegroup")
@AutoConfigureWireMock(stubs = "classpath:/stubs/tidegroup/pis-3.1.1/happy-flow", httpsPort = 0, port = 0)
class TidePaymentProviderHappyFlowIntegrationTest {
    ...
    private static final String PROVIDER_STATE = """
            {"consentId":"f2f36954-2ef9-4c1a-999d-b8d1bbb64f4f","paymentType":"SINGLE","openBankingPayment":"{\\"InstructionIdentification\\":\\"20200515101750462-522347ee-5e0\\",\\"EndToEndIdentification\\":\\"E2EDN5K3\\",\\"InstructedAmount\\":{\\"Amount\\":\\"0.01\\",\\"Currency\\":\\"GBP\\"},\\"CreditorAccount\\":{\\"SchemeName\\":\\"UK.OBIE.SortCodeAccountNumber\\",\\"Identification\\":\\"04060584855930\\",\\"Name\\":\\"Jordan Bell\\"},\\"RemittanceInformation\\":{\\"Unstructured\\":\\"Remi Unstr\\",\\"Reference\\":\\"REF1122336789-4321\\"}}"}""";
    private static Map<String, BasicAuthenticationMean> AUTHENTICATION_MEANS;

    @Autowired
    @Qualifier("TidePaymentProviderV1")
    ...
    public void setup() throws IOException, URISyntaxException {
        AUTHENTICATION_MEANS = TideGroupSampleTypedAuthMeansV2.getAuthenticationMeans();
    }
    ...
    private InitiateUkDomesticPaymentRequestDTO createSampleInitiateRequestDTO() {
        UkAccountDTO creditorAccount = new UkAccountDTO("04060584855930",
        ...
        return new InitiateUkDomesticPaymentRequestDTO(
                ...
                null,
                "Remi Unstr",
                Collections.singletonMap(REMITTANCE_INFORMATION_STRUCTURED_FIELD_NAME, "REF1122336789-4321")
        );
    }
