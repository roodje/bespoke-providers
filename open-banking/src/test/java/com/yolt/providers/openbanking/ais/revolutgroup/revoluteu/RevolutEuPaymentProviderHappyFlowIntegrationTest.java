...
/**
 * This test contains all payment happy flows occuring in Revolut.
 * <p>
 * Covered flows:
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/revolut/pis-3.1.0/eu/happy-flow", httpsPort = 0, port = 0)
public class RevolutEuPaymentProviderHappyFlowIntegrationTest {
    ...
    public void shouldCreateSinglePayment(GenericBaseSepaPaymentProvider subject) throws JsonProcessingException {
        // given
        ...
        assertThat(response.getLoginUrl()).contains("response_type=code+id_token")
                .contains("client_id=" + RevolutSampleAuthenticationMeans.TEST_CLIENT_ID)
        ...
        assertThat(state).extracting(UkProviderState::getConsentId, UkProviderState::getPaymentType, UkProviderState::getOpenBankingPayment).
                contains("58923", PaymentType.SINGLE, """
                        {"InstructionIdentification":"20201202002028103-4b1t742n-102","EndToEndIdentification":"B7F2761C","InstructedAmount":{"Amount":"10000.00","Currency":"EUR"},"CreditorAccount":{"SchemeName":"UK.OBIE.IBAN","Identification":"GB29NWBK60161331926819","Name":"ACME Inc creditor"},"RemittanceInformation":{"Unstructured":"Remittance Unstructured"}}""");
    ...
    @ParameterizedTest
    @MethodSource("getProviders")
    public void shouldCreateSinglePaymentWithDebtor(GenericBaseSepaPaymentProvider subject) throws JsonProcessingException {
        // given
        ...
        assertThat(state).extracting(UkProviderState::getConsentId, UkProviderState::getPaymentType, UkProviderState::getOpenBankingPayment).
                contains("58926", PaymentType.SINGLE, """
                        {"InstructionIdentification":"20201202002028103-4b1t742n-102","EndToEndIdentification":"B7F2761C","InstructedAmount":{"Amount":"10000.00","Currency":"EUR"},"DebtorAccount":{"SchemeName":"UK.OBIE.IBAN","Identification":"GB29NWBK60161331926819","Name":"ACME Inc debtor"},"CreditorAccount":{"SchemeName":"UK.OBIE.IBAN","Identification":"GB29NWBK60161531921819","Name":"ACME Inc creditor"},"RemittanceInformation":{"Unstructured":"Remittance Unstructured"}}""");
    ...
    @ParameterizedTest
    @MethodSource("getProviders")
    public void shouldSubmitSinglePayment(GenericBaseSepaPaymentProvider subject) throws JsonProcessingException {
        // given
    ...
    @ParameterizedTest
    @MethodSource("getProviders")
    public void shouldGetPaymentConsentStatus(GenericBaseSepaPaymentProvider subject) throws JsonProcessingException {
        // given
        var request = creteGetStatusRequest("58920", null);
    ...
    @ParameterizedTest
    @MethodSource("getProviders")
    public void shouldGetPaymentStatus(GenericBaseSepaPaymentProvider subject) throws JsonProcessingException {
        // given
        var request = creteGetStatusRequest("58924", "7290-004");
    ...
    private SepaInitiatePaymentRequestDTO createInitiateRequestDTO(String creditorName, String debtorName) {
        ...
        if (StringUtils.hasText(debtorName)) {
            debtorAccount = new SepaAccountDTO(CurrencyCode.EUR, "GB29NWBK60161331926819");
            dynamicFields.setDebtorName(debtorName);
        }

        SepaAccountDTO creditorAccount = new SepaAccountDTO(CurrencyCode.EUR, "GB29NWBK60161531921819");
    ...
    private GetStatusRequest creteGetStatusRequest(String consentId, String paymentId) {
