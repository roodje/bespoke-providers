...
@AutoConfigureWireMock(stubs = "classpath:/stubs/sainsburys/ais-3.1.1/accounts-500", httpsPort = 0, port = 0)
@ActiveProfiles("sainsburys")
public class SainsburysDataProviderV2FetchData500IntegrationTest {
    ...
    @Test
    public void shouldThrowProviderFetchDataExceptionWhenResponseStatusIs500() throws Exception {
        // given
