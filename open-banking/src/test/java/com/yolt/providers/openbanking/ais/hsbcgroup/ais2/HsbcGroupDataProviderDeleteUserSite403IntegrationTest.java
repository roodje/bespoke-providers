...
class HsbcGroupDataProviderDeleteUserSite403IntegrationTest {
    ...
    void shouldDeleteUserSiteWhenForbiddenStatus(UrlDataProvider provider) {
        // given
        UrlOnUserSiteDeleteRequest urlGetLogin = new UrlOnUserSiteDeleteRequestBuilder()
                .setExternalConsentId("fe24a1ae-61a4-11e9-8647-d663bd873d93")
                .setSigner(SIGNER)
