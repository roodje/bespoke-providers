...
/**
 * This test suite contains case where 500 error is returned from data endpoint in Permanent TSB group providers.
 * <p>
...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/permanenttsbgroup/ais-3.1/accounts-500"}, httpsPort = 0, port = 0)
public class PermanentTsbGroupDataProviderFetchData500IntegrationTest {
    ...
    public void shouldThrowProviderFetchDataExceptionWhenResponseStatusIs500(UrlDataProvider dataProvider) throws Exception {
        // given
