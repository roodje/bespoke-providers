...
public class GenericDefaultHttpClientConnectionResetIntegrationTest {
    ...
    @Test
    public void shouldThrowRootCauseSocketExceptionDueConnectionResetByPeer() throws IOException, URISyntaxException {
