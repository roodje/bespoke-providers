...
/**
 * This test contains data fetch happy flow for Coutts provider it does not test pagination since Coutts removed port from next page url and cannot handle wiremock localhost tests
 * <p>
 * Covered flows:
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/rbsgroup/ob_3.1.6/ais/happy_flow/fetch_data/coutts", port = 0, httpsPort = 0)
class CouttsDataProviderV11DataFetchHappyFlowIntegrationTest {
