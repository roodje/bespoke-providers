...
@AutoConfigureWireMock(stubs = "classpath:/stubs/tescobank/ais-3.1/accounts-403", httpsPort = 0, port = 0)
@ActiveProfiles("tescobank")
public class TescoDataProviderFetchData403IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionOn403(GenericBaseDataProviderV2 provider) throws IOException, URISyntaxException {
        // given
