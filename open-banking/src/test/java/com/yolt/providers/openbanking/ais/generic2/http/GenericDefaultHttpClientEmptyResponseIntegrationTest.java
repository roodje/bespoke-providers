...
public class GenericDefaultHttpClientEmptyResponseIntegrationTest {
    ...
    @Test
    public void shouldThrowRootCauseNoHttpResponseExceptionDueEmptyResponse() throws IOException, URISyntaxException {
