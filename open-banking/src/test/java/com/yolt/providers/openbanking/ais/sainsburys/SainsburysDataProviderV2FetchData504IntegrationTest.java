...
@AutoConfigureWireMock(stubs = "classpath:/stubs/sainsburys/ais-3.1.1/accounts-504", httpsPort = 0, port = 0)
@ActiveProfiles("sainsburys")
public class SainsburysDataProviderV2FetchData504IntegrationTest {
    ...
    @Test
    public void shouldThrowProviderFetchDataExceptionWhenResponseStatusIs504() throws Exception {
        // given
