...
@AutoConfigureWireMock(stubs = "classpath:/stubs/cybgroup/ais-3.1/account-access-consents-delete-403", httpsPort = 0, port = 0)
@ActiveProfiles("cybgroup")
public class CybgGroupDataProviderV3DeleteUserSite403IntegrationTest {
    ...
    void shouldDeleteUserSiteThrowTokenInvalidExceptionWhenResponseStatusIs403(UrlDataProvider provider) throws IOException, URISyntaxException {
        // given
