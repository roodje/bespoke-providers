...
import com.yolt.providers.openbanking.ais.newdaygroup.amazoncreditcard.AmazonCreditCardHttpClientFactory;
import com.yolt.providers.openbanking.ais.newdaygroup.amazoncreditcard.AmazonCreditCardPropertiesV2;
...
@Configuration
public class AmazonCreditCardBeanConfigV2 {

    private static final String IDENTIFIER = "AMAZON_CREDIT_CARD";
    private static final String DISPLAY_NAME = "Amazon Credit Card";
    ...
    private static final String ACCOUNT_NAME_FALLBACK_VALUE = "Amazon Credit Card Account";
    ...
    @Bean("AmazonCreditCardDataProviderV3")
    public AmazonCreditCardDataProviderV3 getAmazonCreditCardDataProviderV3(AmazonCreditCardPropertiesV2 properties,
        ...
        NewDayGroupFetchDataServiceV2 fetchDataService =
                new NewDayGroupFetchDataServiceV2(
                        ...
                        ENDPOINT_VERSION,
                        clock);
        return new AmazonCreditCardDataProviderV3(
                fetchDataService,
                ...
                properties,
                new NewDayGroupAutoOnboardingServiceV2(getRestClient(), properties));
    }
    ...
    private NewDayGroupAuthenticationServiceV2 getAuthenticationService(AmazonCreditCardPropertiesV2 properties, Clock clock, boolean isInPisFlow) {
    ...
    private DefaultHttpClientFactory getHttpClientFactory(DefaultProperties properties, MeterRegistry registry, ObjectMapper objectMapper) {
        return new AmazonCreditCardHttpClientFactory(properties, registry, objectMapper);
    }
