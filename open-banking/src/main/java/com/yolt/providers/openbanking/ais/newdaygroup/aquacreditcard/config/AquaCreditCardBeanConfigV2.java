...
import com.yolt.providers.openbanking.ais.newdaygroup.aquacreditcard.AquaCreditCardPropertiesV2;
...
@Configuration
public class AquaCreditCardBeanConfigV2 {

    private static final String IDENTIFIER = "AQUA_CREDIT_CARD";
    private static final String DISPLAY_NAME = "Aqua Credit Card";
    ...
    @Bean("AquaCreditCardDataProviderV3")
    public GenericBaseDataProvider getAquaCreditCardDataProviderV3(AquaCreditCardPropertiesV2 properties,
        ...
        Function<OBAccount6, String> accountNameFallback = account -> "Aqua Credit Card Account";
    ...
    private NewDayGroupAuthenticationServiceV2 getAuthenticationService(AquaCreditCardPropertiesV2 properties, Clock clock, boolean isInPisFlow) {
