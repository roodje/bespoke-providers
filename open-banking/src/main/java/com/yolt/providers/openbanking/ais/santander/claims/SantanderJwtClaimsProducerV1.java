package com.yolt.providers.openbanking.ais.santander.claims;
...
public class SantanderJwtClaimsProducerV1 extends DefaultJwtClaimsProducer {

    public SantanderJwtClaimsProducerV1(Function<DefaultAuthMeans, String> issuerSupplier,
                                        String audience) {
