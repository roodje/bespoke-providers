...
import com.yolt.providers.openbanking.ais.newdaygroup.houseoffaser.HouseOfFaserPropertiesV2;
...
@Configuration
public class HouseOfFaserBeanConfigV2 {

    private static final String IDENTIFIER = "HOUSE_OF_FASER";
    private static final String DISPLAY_NAME = "House of Faser Credit Card";
    ...
    @Bean("HouseOfFaserDataProviderV3")
    public GenericBaseDataProvider getHouseOfFaserDataProviderV3(HouseOfFaserPropertiesV2 properties,
        ...
        Function<OBAccount6, String> accountNameFallback = account -> "House of Faser Credit Card Account";
    ...
    private NewDayGroupAuthenticationServiceV2 getAuthenticationService(HouseOfFaserPropertiesV2 properties, Clock clock, boolean isInPisFlow) {
