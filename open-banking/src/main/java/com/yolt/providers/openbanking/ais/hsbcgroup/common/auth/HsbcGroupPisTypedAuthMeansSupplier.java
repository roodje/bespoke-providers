...
public class HsbcGroupPisTypedAuthMeansSupplier implements Supplier<Map<String, TypedAuthenticationMeans>> {
    ...
    public Map<String, TypedAuthenticationMeans> get() {
        ...
        typedAuthenticationMeans.put(ORGANIZATION_ID_NAME, TypedAuthenticationMeans.SOFTWARE_ID_STRING);
