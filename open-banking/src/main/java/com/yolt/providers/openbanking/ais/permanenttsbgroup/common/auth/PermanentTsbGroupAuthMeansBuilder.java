package com.yolt.providers.openbanking.ais.permanenttsbgroup.common.auth;
...
public class PermanentTsbGroupAuthMeansBuilder {
    ...
    public static final String SIGNING_KEY_HEADER_ID_NAME = "signing-key-header-id";
    ...
    public static final String ORGANISATION_NAME_NAME = "organisation-name";
    public static final String APPLICATION_NAME_NAME = "application-name";
