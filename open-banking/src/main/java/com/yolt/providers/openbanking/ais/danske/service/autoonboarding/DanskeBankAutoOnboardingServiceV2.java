package com.yolt.providers.openbanking.ais.danske.service.autoonboarding;
...
import com.yolt.providers.openbanking.ais.danske.beanconfig.DanskeBankPropertiesV4;
...
public class DanskeBankAutoOnboardingServiceV2 {
    ...
    private final RegistrationRestClientV2 restClient;
    private final String signatureAlgorithm;
    private final String authMethod;
    private final DanskeBankPropertiesV4 properties;
    ...
    protected JsonWebSignature createJws(Map<String, BasicAuthenticationMean> authMeans,
                                         UrlAutoOnboardingRequest urlAutoOnboardingRequest) throws CertificateException { //NOSONAR https://yolt.atlassian.net/browse/C4PO-7176 after registration it will be reverted. For now list of redirect urls is hardcoded
        ...
        claims.setClaim(TLS_CLIENT_AUTH_SUBJECT_DN_CLAIM, getSubjectDomainName(authMeans.get(TRANSPORT_CERTIFICATE_NAME).getValue()));
    ...
    private boolean isRegistrationRequestValid(UrlAutoOnboardingRequest urlAutoOnboardingRequest) {
        return RegistrationOperation.UPDATE.equals(urlAutoOnboardingRequest.getRegistrationOperation()) ||
                (RegistrationOperation.CREATE.equals(urlAutoOnboardingRequest.getRegistrationOperation()) && !urlAutoOnboardingRequest.getAuthenticationMeans().containsKey(CLIENT_ID_NAME));
    }
