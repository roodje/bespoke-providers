...
@Service
public class DebenhamsDetailsProvider implements AisDetailsProvider {

    private static final String SITE_ID = "f4bf37bc-204b-4f11-9e3c-44215863afc7";
    private static final String PROVIDER_NAME = "Debenhams Credit Card";
    private static final String PROVIDER_KEY = "DEBENHAMS";
