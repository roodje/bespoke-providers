package com.yolt.providers.openbanking.ais.danske.service.restclient;
...
public class RegistrationRestClientV2 extends DefaultRestClient {

    public RegistrationRestClientV2(PaymentRequestSigner payloadSigner) {
        super(payloadSigner);
    }
