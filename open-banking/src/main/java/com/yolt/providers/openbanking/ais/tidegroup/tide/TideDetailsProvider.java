...
@Service
public class TideDetailsProvider implements AisDetailsProvider, PisDetailsProvider {

    private static final String SITE_ID = "e649db85-9e6b-46d0-8bba-d11fa816270c";
    private static final String PROVIDER_NAME = "Tide";
