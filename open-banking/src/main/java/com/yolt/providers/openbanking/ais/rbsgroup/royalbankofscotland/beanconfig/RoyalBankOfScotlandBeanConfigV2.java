...
@Configuration
public class RoyalBankOfScotlandBeanConfigV2 {

    private static final String ENDPOINT_VERSION = "/v3.1";
    private static final String IDENTIFIER = "ROYAL_BANK_OF_SCOTLAND";
    private static final String DISPLAY_NAME = "Royal Bank of Scotland";
    private static final Function<OBAccount6, String> ACCOUNT_NAME_FALLBACK = account -> "Royal Bank of Scotland Account";
    private static final int EXPIRATION_TIME_IN_MINUTES = 1;

    @Bean("RoyalBankOfScotlandDataProviderV11")
    public RbsGroupDataProviderV5 getRoyalBankOfScotlandDataProviderV11(RoyalBankOfScotlandPropertiesV2 properties,
    ...
    @Bean("RoyalBankOfScotlandPaymentProviderV11")
    public GenericBasePaymentProviderV2 getRoyalBankOfScotlandPaymentProviderV11(RoyalBankOfScotlandPropertiesV2 properties,
                                                                                 MeterRegistry registry,
                                                                                 Clock clock,
                                                                                 @Qualifier("OpenBanking") ObjectMapper objectMapper) {
        ProviderIdentification providerIdentification = new ProviderIdentification(IDENTIFIER, DISPLAY_NAME, VERSION_11);
    ...
    private FetchDataService getFetchDataService(RoyalBankOfScotlandPropertiesV2 properties, Clock clock) {
    ...
    private AuthenticationService getAuthenticationService(RoyalBankOfScotlandPropertiesV2 properties,
