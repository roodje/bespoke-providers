package com.yolt.providers.openbanking.ais.virginmoney2group.common.producer;
...
public class VirginMoney2GroupTokenBodyProducer extends BasicOauthTokenBodyProducer {

    private final TokenScope scope;

    public VirginMoney2GroupTokenBodyProducer(final TokenScope scope) {
        this.scope = scope;
    }
