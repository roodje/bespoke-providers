package com.yolt.providers.openbanking.ais.rbsgroup.royalbankofscotlandcorporate.beanconfig;
...
@Configuration
public class RoyalBankOfScotlandCorporateBeanConfigV2 {

    private static final String ENDPOINT_VERSION = "/v3.1";
    private static final String IDENTIFIER = "ROYAL_BANK_OF_SCOTLAND_CORPO";
    private static final String DISPLAY_NAME = "Royal Bank of Scotland - corporate accounts";
    private static final Function<OBAccount6, String> ACCOUNT_NAME_FALLBACK = account -> "Royal Bank of Scotland Corporate Account";
    private static final int EXPIRATION_TIME_IN_MINUTES = 1;

    @Bean("RoyalBankOfScotlandCorporateDataProviderV10")
    public RbsGroupDataProviderV5 getRoyalBankOfScotlandCorporateDataProviderV10(RoyalBankOfScotlandCorporatePropertiesV2 properties,
    ...
    private FetchDataService getFetchDataService(RoyalBankOfScotlandCorporatePropertiesV2 properties, Clock clock) {
    ...
    private AuthenticationService getAuthenticationService(RoyalBankOfScotlandCorporatePropertiesV2 properties,
