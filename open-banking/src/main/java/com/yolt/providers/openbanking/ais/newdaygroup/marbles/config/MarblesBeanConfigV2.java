...
import com.yolt.providers.openbanking.ais.newdaygroup.marbles.MarblesPropertiesV2;
...
@Configuration
public class MarblesBeanConfigV2 {

    private static final String IDENTIFIER = "MARBLES";
    private static final String DISPLAY_NAME = "Marbles Credit Card";
    ...
    @Bean("MarblesDataProviderV3")
    public GenericBaseDataProvider getMarblesDataProviderV3(MarblesPropertiesV2 properties,
        ...
        Function<OBAccount6, String> accountNameFallback = account -> "Marbles Credit Card Account";
    ...
    private NewDayGroupAuthenticationServiceV2 getAuthenticationService(MarblesPropertiesV2 properties, Clock clock, boolean isInPisFlow) {
