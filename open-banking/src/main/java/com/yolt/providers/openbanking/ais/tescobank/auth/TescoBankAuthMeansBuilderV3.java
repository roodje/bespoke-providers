package com.yolt.providers.openbanking.ais.tescobank.auth;
...
public class TescoBankAuthMeansBuilderV3 {
    ...
    public static DefaultAuthMeans createAuthenticationMeans(final Map<String, BasicAuthenticationMean> typedAuthenticationMeans) {
        return DefaultAuthMeans.builder()
                ...
                .organizationId(getOptionalAuthenticationMeanValue(typedAuthenticationMeans, ORGANIZATION_ID_NAME))
                .softwareId(getOptionalAuthenticationMeanValue(typedAuthenticationMeans, SOFTWARE_ID_NAME))
                .build();
    }

    public static Supplier<Map<String, TypedAuthenticationMeans>> getTypedAuthenticationMeansForAIS() {
        Map<String, TypedAuthenticationMeans> typedAuthenticationMeans = getTypedAuthenticationMeansForPIS().get();
    ...
    private static X509Certificate createCertificate(final String certificate) {
        try {
            ...
            throw new InvalidAuthenticationMeansException("Tesco Bank", TRANSPORT_CERTIFICATE_NAME, "Cannot process certificate for thumbprint");
        }
    }

    private static String getOptionalAuthenticationMeanValue(final Map<String, BasicAuthenticationMean> authenticationMeansMap, final String key) {
