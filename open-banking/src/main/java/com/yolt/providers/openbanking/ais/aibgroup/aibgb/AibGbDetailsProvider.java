...
@Service
public class AibGbDetailsProvider implements AisDetailsProvider, PisDetailsProvider {
    public static final String PROVIDER_KEY = "AIB";
    public static final String PROVIDER_DISPLAY_NAME = "AIB";
    public static final String AIB_GB_SITE_ID = "5806ae85-7ee6-48a5-98ea-0f464b9b71cb";

    private static final List<AisSiteDetails> AIS_SITE_DETAILS = List.of(
            site(AIB_GB_SITE_ID, PROVIDER_DISPLAY_NAME, PROVIDER_KEY, DIRECT_CONNECTION, of(STATE), of(CURRENT_ACCOUNT, CREDIT_CARD, SAVINGS_ACCOUNT), of(GB))
                    .groupingBy("Allied Irish Bank (GB)")
    ...
    private static final List<PisSiteDetails> PIS_SITE_DETAILS = List.of(
            PisSiteDetails.builder()
                    .id(UUID.fromString(AIB_GB_SITE_ID))
