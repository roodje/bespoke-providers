...
@Service
public class VirginMoneyDetailsProvider implements AisDetailsProvider, PisDetailsProvider {

    private static final String SITE_ID = "aff01911-7e22-4b9e-8b86-eae36cf7b732";
    private static final String PROVIDER_NAME = "Virgin Money Credit card";
    private static final String PROVIDER_KEY = "VIRGIN_MONEY";
