package com.yolt.providers.openbanking.ais.aibgroup.common.auth;
...
public class AibGroupAuthMeansBuilderV3 {
    ...
    private static DefaultAuthMeans.DefaultAuthMeansBuilder createAuthenticationMeans(final Map<String, BasicAuthenticationMean> typedAuthenticationMeans,
    ...
    public static DefaultAuthMeans createAuthenticationMeansForPis(final Map<String, BasicAuthenticationMean> typedAuthenticationMeans,
                                                                   final String providerKey) {
        return createAuthenticationMeans(typedAuthenticationMeans, providerKey)
