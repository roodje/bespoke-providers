...
@Deprecated //Use newer version with permissions passed in state C4PO-8398
@RequiredArgsConstructor
public class GenericBaseDataProvider implements UrlDataProvider {
    ...
    public DataProviderResponse fetchData(final UrlFetchDataRequest request) throws ProviderFetchDataException, TokenInvalidException {
        ...
        return fetchDataService.getAccountsAndTransactions(httpClient,
                ...
                accessMeansMapper.fromJson(request.getAccessMeans().getAccessMeans()));
    }
    ...
    public Step getLoginInfo(final UrlGetLoginRequest request) {
        ...
        try {
            ...
            return new RedirectStep(authorizationUrl, accountRequestId, null);
        } catch (Exception e) {
    ...
    public AccessMeansOrStepDTO createNewAccessMeans(final UrlCreateAccessMeansRequest request) {
        ...
        try {
            ...
            String accessMeansValue = accessMeansMapper.toJson(accessToken);
