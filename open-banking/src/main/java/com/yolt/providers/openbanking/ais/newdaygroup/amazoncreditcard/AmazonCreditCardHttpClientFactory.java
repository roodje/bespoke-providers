...
public class AmazonCreditCardHttpClientFactory extends DefaultHttpClientFactory {

    private static final long KEEP_ALIVE_TIMEOUT_IN_MILLIS = 1000L;

    private final DefaultProperties properties;
    private final ObjectMapper mapper;

    public AmazonCreditCardHttpClientFactory(DefaultProperties properties, MeterRegistry registry, ObjectMapper mapper) {
