...
import com.yolt.providers.openbanking.ais.hsbcgroup.firstdirect.FirstDirectPropertiesV2;
...
@Configuration
public class FirstDirectBeanConfigV2 {

    private static final String IDENTIFIER = "FIRST_DIRECT";
    private static final String DISPLAY_NAME = "First Direct";
    ...
    @Bean("FirstDirectDataProviderV13")
    public HsbcGroupBaseDataProviderV7 getFirstDirectDataProviderV13(FirstDirectPropertiesV2 properties,
        ...
        Function<OBAccount6, String> accountNameFallback = any -> "First Direct Account";
    ...
    @Bean("FirstDirectPaymentProviderV13")
    public GenericBasePaymentProviderV2 getFirstDirectPaymentProviderV13(FirstDirectPropertiesV2 properties,
                                                                         MeterRegistry registry,
                                                                         Clock clock,
                                                                         @Qualifier("OpenBanking") ObjectMapper objectMapper) {
    ...
    @Bean("FirstDirectPaymentProviderV14")
    public GenericBasePaymentProviderV3 getFirstDirectPaymentProviderV14(FirstDirectPropertiesV2 properties,
                                                                         MeterRegistry registry,
                                                                         Clock clock,
                                                                         @Qualifier("OpenBanking") ObjectMapper objectMapper) {
