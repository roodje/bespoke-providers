...
@Configuration
public class ClydesdaleBeanConfigV2 {

    private static final String IDENTIFIER = "CLYDESDALE_BANK";
    private static final String DISPLAY_NAME = "Clydesdale Bank";
    ...
    @Bean("ClydesdaleDataProvider")
    public CybgGroupDataProviderV3 getClydesdaleDataProvider(ClydesdalePropertiesV2 properties,
        ...
        Function<OBAccount6, String> accountNameFallback = account -> "Clydesdale Bank Account";
    ...
    private DefaultAuthenticationService getAuthenticationService(ClydesdalePropertiesV2 properties,
                                                                  boolean isInPisFlow,
                                                                  CybgGroupFetchDataServiceV3 fetchDataService,
    ...
    private DefaultAuthMeans createAuthenticationMeans(Map<String, BasicAuthenticationMean> authMeans, String providerKey, ClydesdalePropertiesV2 properties) {
