package com.yolt.providers.openbanking.ais.monzogroup.common.auth;
...
public class MonzoGroupAuthMeansMapper {
    ...
    public Function<Map<String, BasicAuthenticationMean>, DefaultAuthMeans> getAuthMeansMapper(String providerKey) {
        return typedAuthenticationMeans -> DefaultAuthMeans.builder()
                .clientId(getOptionalAuthMeanValue(typedAuthenticationMeans, CLIENT_ID_NAME))
    ...
    private X509Certificate createCertificate(final String certificate, final String providerKey) {
        try {
    ...
    private String getOptionalAuthMeanValue(final Map<String, BasicAuthenticationMean> authenticationMeansMap,
                                            final String key) {
