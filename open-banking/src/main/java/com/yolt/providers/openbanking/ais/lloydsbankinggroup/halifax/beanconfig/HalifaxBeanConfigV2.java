...
import com.yolt.providers.openbanking.ais.lloydsbankinggroup.halifax.HalifaxPropertiesV2;
...
@Configuration
public class HalifaxBeanConfigV2 {

    public static final String ACCOUNT_NAME_FALLBACK = "Halifax Account";
    private static final String PROVIDER_IDENTIFIER = "HALIFAX";
    private static final String PROVIDER_DISPLAY_NAME = "Halifax";
    private static final String ENDPOINT_VERSION = "/v3.1";

    private FetchDataService getFetchDataService(HalifaxPropertiesV2 properties,
                                                 Clock clock,
    ...
    public AuthenticationService getAuthenticationService(final HalifaxPropertiesV2 properties,
    ...
    private AccountRequestService getAccountRequestService(final ObjectMapper mapper,
                                                           ...
                                                           final HalifaxPropertiesV2 properties) {
    ...
    @Bean("HalifaxDataProviderV10")
    public GenericBaseDataProvider getHalifaxDataProviderV10(@Qualifier("OpenBanking") final ObjectMapper objectMapper,
                                                             final HalifaxPropertiesV2 properties,
    ...
    @Bean("HalifaxPaymentProviderV11")
    public GenericBasePaymentProviderV2 getHalifaxPaymentProviderV11(@Qualifier("OpenBanking") final ObjectMapper objectMapper,
                                                                     final HalifaxPropertiesV2 properties,
                                                                     final MeterRegistry registry,
                                                                     final Clock clock) {
