...
import com.yolt.providers.openbanking.ais.hsbcgroup.common.HsbcGroupCommonPaymentProviderFactory;
import com.yolt.providers.openbanking.ais.hsbcgroup.common.HsbcGroupCommonPaymentProviderFactoryV2;
...
import com.yolt.providers.openbanking.ais.hsbcgroup.hsbc.HsbcPropertiesV2;
import com.yolt.providers.openbanking.ais.hsbcgroup.hsbc.common.http.HsbcRestClient;
import com.yolt.providers.openbanking.ais.hsbcgroup.hsbc.common.http.errorhandler.HsbcClosedAndBlockedAccountErrorHandler;
...
import static com.yolt.providers.common.versioning.ProviderVersion.VERSION_14;
...
@Configuration
public class HsbcBeanConfigV2 {

    private static final String IDENTIFIER = "HSBC";
    private static final String DISPLAY_NAME = "HSBC";
    ...
    private DefaultRestClient getRestClient(ObjectMapper objectMapper) {
        return new HsbcRestClient(getPayloadSigner(objectMapper));
    }

    @Bean("HsbcDataProviderV13")
    public HsbcGroupBaseDataProviderV7 getHsbcDataProviderV13(HsbcPropertiesV2 properties,
        ...
        Function<OBAccount6, String> accountNameFallback = any -> "HSBC Account";
        ...
        FetchDataServiceV2 fetchDataService =
                new DefaultHsbcGroupFetchDataServiceV8(
                        ...
                        new HsbcClosedAndBlockedAccountErrorHandler());
    ...
    @Bean("HsbcPaymentProviderV13")
    public GenericBasePaymentProviderV2 getHsbcPaymentProviderV13(HsbcPropertiesV2 properties,
                                                                  MeterRegistry registry,
                                                                  Clock clock,
                                                                  @Qualifier("OpenBanking") ObjectMapper objectMapper) {
        return HsbcGroupCommonPaymentProviderFactory.createPaymentProvider(
                new ProviderIdentification(IDENTIFIER, DISPLAY_NAME, VERSION_13),
                getAuthenticationService(properties, clock, true),
                getHttpClientFactory(properties, registry, objectMapper),
                getPayloadSigner(objectMapper),
                objectMapper,
                () -> ENDPOINT_VERSION,
                clock);
    }

    @Bean("HsbcPaymentProviderV14")
    public GenericBasePaymentProviderV3 getHsbcPaymentProviderV14(HsbcPropertiesV2 properties,
                                                                  MeterRegistry registry,
                                                                  Clock clock,
                                                                  @Qualifier("OpenBanking") ObjectMapper objectMapper) {
        return HsbcGroupCommonPaymentProviderFactoryV2.createPaymentProvider(
                new ProviderIdentification(IDENTIFIER, DISPLAY_NAME, VERSION_14),
                getAuthenticationService(properties, clock, true),
                getHttpClientFactory(properties, registry, objectMapper),
                getPayloadSigner(objectMapper),
                objectMapper,
