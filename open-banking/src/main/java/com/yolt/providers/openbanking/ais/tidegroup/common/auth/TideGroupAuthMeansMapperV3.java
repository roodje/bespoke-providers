package com.yolt.providers.openbanking.ais.tidegroup.common.auth;
...
public class TideGroupAuthMeansMapperV3 {

    public static final String INSTITUTION_ID_NAME = "institution-id-2";
    public static final String CLIENT_ID_NAME = "client-id-2";
    public static final String SIGNING_KEY_HEADER_ID_NAME = "signing-private-key-header-id-2";
    ...
    private DefaultAuthMeans mapToDefaultAuthMeans(final Map<String, BasicAuthenticationMean> typedAuthenticationMeans,
    ...
    private X509Certificate createCertificate(final String certificate, final String providerIdentifier) {
        try {
