...
import com.yolt.providers.openbanking.ais.lloydsbankinggroup.bankofscotlandcorpo.BankOfScotlandCorpoPropertiesV2;
...
import static com.yolt.providers.common.versioning.ProviderVersion.VERSION_8;
...
@Configuration
public class BankOfScotlandCorpoBeanConfigV2 {

    public static final String ACCOUNT_NAME_FALLBACK = "Bank of Scotland Corporate Account";

    private static final String ENDPOINT_VERSION = "/v3.1";
    private static final String PROVIDER_IDENTIFIER = "BANK_OF_SCOTLAND_CORPO";
    private static final String PROVIDER_DISPLAY_NAME = "Bank of Scotland - corporate accounts";

    private FetchDataService getFetchDataService(BankOfScotlandCorpoPropertiesV2 properties,
                                                 Clock clock,
    ...
    public AuthenticationService getAuthenticationService(final BankOfScotlandCorpoPropertiesV2 properties,
    ...
    private AccountRequestService getAccountRequestService(final ObjectMapper mapper,
                                                           ...
                                                           final BankOfScotlandCorpoPropertiesV2 properties) {
    ...
    @Bean("BankOfScotlandCorpoDataProviderV8")
    public GenericBaseDataProvider getBankOfScotlandCorpoDataProviderV8(@Qualifier("OpenBanking") final ObjectMapper objectMapper,
                                                                        final BankOfScotlandCorpoPropertiesV2 properties,
        ...
        return new GenericBaseDataProvider(getFetchDataService(properties, clock, objectMapper),
                ...
                scope,
                new ProviderIdentification(PROVIDER_IDENTIFIER, PROVIDER_DISPLAY_NAME, VERSION_8),
