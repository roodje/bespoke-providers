...
@Configuration
public class UlsterBankBeanConfigV2 {

    private static final String ENDPOINT_VERSION = "/v3.1";
    private static final String IDENTIFIER = "ULSTER_BANK";
    private static final String DISPLAY_NAME = "Ulster Bank";
    private static final Function<OBAccount6, String> ACCOUNT_NAME_FALLBACK = account -> "Ulster Bank Account";
    private static final int EXPIRATION_TIME_IN_MINUTES = 1;

    @Bean("UlsterBankDataProviderV10")
    public RbsGroupDataProviderV5 getUlsterBankDataProviderV10(UlsterBankPropertiesV2 properties,
    ...
    @Bean("UlsterBankPaymentProviderV10")
    public GenericBasePaymentProviderV2 getUlsterBankPaymentProviderV10(UlsterBankPropertiesV2 properties,
                                                                        MeterRegistry registry,
                                                                        Clock clock,
                                                                        @Qualifier("OpenBanking") ObjectMapper objectMapper) {
        ProviderIdentification providerIdentification = new ProviderIdentification(IDENTIFIER, DISPLAY_NAME, VERSION_10);
    ...
    private FetchDataService getFetchDataService(UlsterBankPropertiesV2 properties, Clock clock) {
    ...
    private AuthenticationService getAuthenticationService(UlsterBankPropertiesV2 properties,
