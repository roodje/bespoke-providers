...
import com.yolt.providers.openbanking.ais.newdaygroup.argos.ArgosPropertiesV2;
...
@Configuration
public class ArgosBeanConfigV2 {

    private static final String IDENTIFIER = "ARGOS";
    private static final String DISPLAY_NAME = "Argos Credit Card";
    ...
    private static final String ACCOUNT_NAME_FALLBACK_VALUE = "Argos Credit Card Account";
    ...
    @Bean("ArgosDataProviderV3")
    public GenericBaseDataProvider getArgosDataProviderV3(ArgosPropertiesV2 properties,
    ...
    private NewDayGroupAuthenticationServiceV2 getAuthenticationService(ArgosPropertiesV2 properties, Clock clock, boolean isInPisFlow) {
