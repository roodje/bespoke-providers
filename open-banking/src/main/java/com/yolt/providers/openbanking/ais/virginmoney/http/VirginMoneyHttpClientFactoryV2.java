...
public class VirginMoneyHttpClientFactoryV2 extends DefaultHttpClientFactory {
    public VirginMoneyHttpClientFactoryV2(DefaultProperties properties, MeterRegistry registry, ObjectMapper mapper) {
    ...
    protected ClientHttpRequestInterceptor[] getClientHttpRequestInterceptors() {
        return new ClientHttpRequestInterceptor[]{
                new VirginMoneyClientHttpRequestInterceptor()
        };
    }
}
