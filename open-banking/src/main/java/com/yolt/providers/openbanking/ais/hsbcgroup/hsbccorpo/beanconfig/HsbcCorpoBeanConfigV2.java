...
import com.yolt.providers.openbanking.ais.hsbcgroup.hsbccorpo.HsbcCorpoPropertiesV2;
...
@Configuration
public class HsbcCorpoBeanConfigV2 {


    private static final String IDENTIFIER = "HSBC_CORPO";
    private static final String DISPLAY_NAME = "HSBC - corporate accounts";
    ...
    private DefaultRestClient getRestClient(ObjectMapper objectMapper) {
        return new DefaultHsbcGroupRestClientV5(
                new HsbcGroupPaymentRequestSigner(
                        objectMapper,
    ...
    @Bean("HsbcCorpoDataProviderV11")
    public HsbcGroupBaseDataProviderV7 getHsbcCorpoDataProviderV11(HsbcCorpoPropertiesV2 properties,
                                                                   MeterRegistry registry,
                                                                   Clock clock,
        ...
        Supplier<List<OBBalanceType1Code>> getCurrentBalanceType = () -> Arrays.asList(EXPECTED);
        Supplier<List<OBBalanceType1Code>> getAvailableBalanceType = () -> Arrays.asList(INTERIMAVAILABLE);
        Function<OBAccount6, String> accountNameFallback = any -> "HSBC Corporate Account";
        ...
        return new HsbcGroupBaseDataProviderV7(
                ...
                () -> {
                    ...
                    keywords.add("HSBC Authentication");
