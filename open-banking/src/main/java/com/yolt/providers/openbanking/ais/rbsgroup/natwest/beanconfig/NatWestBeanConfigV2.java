...
import com.yolt.providers.openbanking.ais.rbsgroup.common.pec.RbsGroupCommonPaymentProviderFactory;
...
import com.yolt.providers.openbanking.ais.rbsgroup.natwest.common.http.NatwestHttpClientFactory;
...
@Configuration
public class NatWestBeanConfigV2 {

    private static final String ENDPOINT_VERSION = "/v3.1";
    private static final String IDENTIFIER = "NATWEST";
    private static final String DISPLAY_NAME = "Natwest";
    private static final Function<OBAccount6, String> ACCOUNT_NAME_FALLBACK = account -> "Natwest Account";
    private static final int EXPIRATION_TIME_IN_MINUTES = 1;

    @Bean("NatWestDataProviderV11")
    public RbsGroupDataProviderV5 getNatWestDataProviderV11(NatWestPropertiesV2 properties,
        ...
        TokenScope scope = TokenScope.builder()
                ...
                .build();
        ProviderIdentification providerIdentification = new ProviderIdentification(IDENTIFIER, DISPLAY_NAME, VERSION_11);
        HttpClientFactory httpClientFactory = new NatwestHttpClientFactory(properties, registry, objectMapper);
    ...
    @Bean("NatWestPaymentProviderV11")
    public GenericBasePaymentProviderV2 getNatWestPaymentProviderV11(NatWestPropertiesV2 properties,
                                                                     MeterRegistry registry,
                                                                     Clock clock,
                                                                     @Qualifier("OpenBanking") ObjectMapper objectMapper) {
        ProviderIdentification providerIdentification = new ProviderIdentification(IDENTIFIER, DISPLAY_NAME, VERSION_11);
        ...
        return RbsGroupCommonPaymentProviderFactory.createPaymentProvider(providerIdentification,
                authenticationService,
                properties,
                registry,
                objectMapper,
    ...
    private FetchDataService getFetchDataService(NatWestPropertiesV2 properties, Clock clock) {
    ...
    private AuthenticationService getAuthenticationService(NatWestPropertiesV2 properties,
        ...
        Oauth2Client oauth2Client = new PrivateKeyJwtOauth2Client<>(
