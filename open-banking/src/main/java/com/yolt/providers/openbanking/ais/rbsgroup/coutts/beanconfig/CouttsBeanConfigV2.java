...
import com.yolt.providers.openbanking.ais.rbsgroup.coutts.CouttsPropertiesV2;
import com.yolt.providers.openbanking.ais.rbsgroup.coutts.http.CouttsHttpClientFactoryV2;
import com.yolt.providers.openbanking.ais.rbsgroup.coutts.service.ais.fetchdataservice.CouttsFetchDataServiceV2;
import com.yolt.providers.openbanking.ais.rbsgroup.coutts.service.ais.fetchdataservice.PortRemovalUrlAdapter;
import com.yolt.providers.openbanking.ais.rbsgroup.coutts.service.claims.CouttsJwtClaimsProducerDecorator;
...
@Configuration
public class CouttsBeanConfigV2 {

    private static final String ENDPOINT_VERSION = "/v3.1";
    private static final String IDENTIFIER = "COUTTS";
    private static final String DISPLAY_NAME = "Coutts";
    private static final Function<OBAccount6, String> ACCOUNT_NAME_FALLBACK = account -> {
        switch (account.getAccountSubType()) {
            case CURRENTACCOUNT:
            ...
            default:
                return "Coutts Account";
        }
    };
    private static final int EXPIRATION_TIME_IN_MINUTES = 60;


    @Bean("CouttsDataProviderV3")
    public RbsGroupDataProviderV5 getCouttsDataProviderV3(CouttsPropertiesV2 properties,
        ...
        HttpClientFactory httpClientFactory = new CouttsHttpClientFactoryV2(properties, registry, objectMapper);
        ...
        Supplier<ConsentValidityRules> consentValidityRulesSupplier = () -> ConsentValidityRules.EMPTY_RULES_SET;
    ...
    private AuthenticationService getAuthenticationService(CouttsPropertiesV2 properties,
        ...
        return new DefaultAuthenticationService(properties.getOAuthAuthorizationUrl(),
                ...
                new DefaultTokenClaimsProducer(
                        new CouttsJwtClaimsProducerDecorator(
    ...
    private FetchDataService getFetchDataService(CouttsPropertiesV2 properties, Clock clock) {
        ...
        Supplier<List<OBBalanceType1Code>> getCurrentBalanceType = () -> Collections.singletonList(INTERIMBOOKED);
        Supplier<List<OBBalanceType1Code>> getAvailableBalanceType = () -> Collections.singletonList(INTERIMAVAILABLE);
        ...
        return new CouttsFetchDataServiceV2(
