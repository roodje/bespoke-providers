...
import com.yolt.providers.openbanking.ais.lloydsbankinggroup.bankofscotland.BankOfScotlandPropertiesV2;
...
@Configuration
public class BankOfScotlandBeanConfigV2 {

    public static final String ACCOUNT_NAME_FALLBACK = "Bank of Scotland Account";
    private static final String ENDPOINT_VERSION = "/v3.1";
    private static final String PROVIDER_IDENTIFIER = "BANK_OF_SCOTLAND";
    private static final String PROVIDER_DISPLAY_NAME = "Bank of Scotland";

    private FetchDataService getFetchDataService(BankOfScotlandPropertiesV2 properties,
                                                 Clock clock,
    ...
    public AuthenticationService getAuthenticationService(final BankOfScotlandPropertiesV2 properties,
                                                          final UserRequestTokenSigner tokenSigner,
                                                          final Clock clock,
                                                          final boolean isInPisProvider) {
    ...
    private AccountRequestService getAccountRequestService(final ObjectMapper mapper,
                                                           ...
                                                           final BankOfScotlandPropertiesV2 properties) {
    ...
    @Bean("BankOfScotlandDataProviderV10")
    public GenericBaseDataProvider getBankOfScotlandDataProviderV10(@Qualifier("OpenBanking") final ObjectMapper objectMapper,
                                                                    final BankOfScotlandPropertiesV2 properties,
    ...
    @Bean("BankOfScotlandPaymentProviderV11")
    public GenericBasePaymentProviderV2 getBankOfScotlandPaymentProviderV11(@Qualifier("OpenBanking") final ObjectMapper objectMapper,
                                                                            final BankOfScotlandPropertiesV2 properties,
                                                                            final MeterRegistry registry,
                                                                            final Clock clock) {
