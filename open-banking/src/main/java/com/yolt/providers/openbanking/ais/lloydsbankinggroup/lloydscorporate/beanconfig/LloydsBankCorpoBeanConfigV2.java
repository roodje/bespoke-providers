...
import com.yolt.providers.openbanking.ais.lloydsbankinggroup.lloydscorporate.LloydsBankCorpoPropertiesV2;
...
@Configuration
public class LloydsBankCorpoBeanConfigV2 {

    private static final String ACCOUNT_NAME_FALLBACK = "Lloyds Bank Corporate Account";
    private static final String ENDPOINT_VERSION = "/v3.1";
    private static final String PROVIDER_IDENTIFIER = "LLOYDS_BANK_CORPO";
    private static final String PROVIDER_DISPLAY_NAME = "Lloyds Bank - corporate accounts";


    private FetchDataService getFetchDataService(LloydsBankCorpoPropertiesV2 properties,
                                                 Clock clock,
    ...
    public AuthenticationService getAuthenticationService(final LloydsBankCorpoPropertiesV2 properties,
    ...
    private AccountRequestService getAccountRequestService(final ObjectMapper mapper,
                                                           ...
                                                           final LloydsBankCorpoPropertiesV2 properties) {
    ...
    @Bean("LloydsBankCorpoDataProviderV8")
    public GenericBaseDataProvider getLloydsBankCorpoDataProviderV8(@Qualifier("OpenBanking") final ObjectMapper objectMapper,
                                                                    final LloydsBankCorpoPropertiesV2 properties,
