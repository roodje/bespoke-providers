...
import static com.yolt.providers.openbanking.ais.aibgroup.aibni.AibNiDetailsProvider.PROVIDER_DISPLAY_NAME;
import static com.yolt.providers.openbanking.ais.aibgroup.aibni.AibNiDetailsProvider.PROVIDER_KEY;
...
public class AibNIBeanConfigV2 {
    ...
    private FetchDataService getFetchDataService(AibNIPropertiesV2 properties,
        ...
        return new DefaultFetchDataService(new DefaultRestClient(new ExternalPaymentRequestSigner(objectMapper, AlgorithmIdentifiers.RSA_PSS_USING_SHA256)), properties,
                ...
                new AibGroupAccountMapperV3(() -> Arrays.asList(OPENINGAVAILABLE), () -> Arrays.asList(INTERIMAVAILABLE),
                        ...
                        new DefaultAccountNameMapper(account -> "AIB (NI) Account"),
    ...
    private AuthenticationService getAuthenticationServiceV2(final AibNIPropertiesV2 properties,
    ...
    @Bean("AibNIDataProviderV6")
    public GenericBaseDataProvider getAibNiDataProviderV6(final AibNIPropertiesV2 properties,
                                                          final Clock clock,
    ...
    @Bean("AibNiPaymentProviderV1")
    public GenericBaseSepaPaymentProvider getAibNiPaymentProvider(final AibNIPropertiesV2 properties,
                                                                  final MeterRegistry registry,
                                                                  final Clock clock,
        ...
        PaymentDataInitiationMapper ukDomesticDataInitiationMapper = new PaymentDataInitiationMapper(
                ...
                new DefaultUkSchemeMapper()
        )
                .withDebtorAccount()
                .withLocalInstrument(LOCAL_INSTRUMENT)
                .validateAfterMapWith(new AibNIPaymentRequestValidator());
    ...
    private AuthenticationService getAuthenticationServiceV2ForPis(final AibNIPropertiesV2 properties,
                                                                   final ExternalUserRequestTokenSigner tokenSigner,
                                                                   final Clock clock) {
