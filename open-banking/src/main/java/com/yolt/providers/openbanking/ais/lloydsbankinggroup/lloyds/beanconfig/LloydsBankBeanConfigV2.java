...
import com.yolt.providers.openbanking.ais.lloydsbankinggroup.lloyds.Lloyds.common.http.LloydsBankHttpClientFactory;
import com.yolt.providers.openbanking.ais.lloydsbankinggroup.lloyds.LloydsBankPropertiesV2;
...
@Configuration
public class LloydsBankBeanConfigV2 {

    public static final String ACCOUNT_NAME_FALLBACK = "Lloyds Bank Account";
    private static final String PROVIDER_IDENTIFIER = "LLOYDS_BANK";
    private static final String PROVIDER_DISPLAY_NAME = "Lloyds Bank";
    private static final String ENDPOINT_VERSION = "/v3.1";

    private FetchDataService getFetchDataService(LloydsBankPropertiesV2 properties,
                                                 Clock clock,
    ...
    public AuthenticationService getAuthenticationService(final LloydsBankPropertiesV2 properties,
    ...
    private AccountRequestService getAccountRequestService(final ObjectMapper mapper,
                                                           ...
                                                           final LloydsBankPropertiesV2 properties) {
    ...
    @Bean("LloydsBankDataProviderV10")
    public GenericBaseDataProvider getLloydsBankDataProviderV10(@Qualifier("OpenBanking") final ObjectMapper objectMapper,
                                                                final LloydsBankPropertiesV2 properties,
        ...
        return new GenericBaseDataProvider(getFetchDataService(properties, clock, objectMapper),
                ...
                new LloydsBankHttpClientFactory(properties, registry, objectMapper),
                scope,
                new ProviderIdentification(PROVIDER_IDENTIFIER, PROVIDER_DISPLAY_NAME, VERSION_10),
    ...
    @Bean("LloydsBankPaymentProviderV11")
    public GenericBasePaymentProviderV2 getLloydsBankPaymentProviderV11(@Qualifier("OpenBanking") final ObjectMapper objectMapper,
                                                                        final LloydsBankPropertiesV2 properties,
                                                                        final MeterRegistry registry,
                                                                        final Clock clock) {
