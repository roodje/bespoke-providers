...
public class BankOfIrelandRoiDataProvider extends BankOfIrelandGroupBaseDataProvider implements AutoOnboardingProvider {
    ...
    public BankOfIrelandRoiDataProvider(FetchDataService fetchDataService,
