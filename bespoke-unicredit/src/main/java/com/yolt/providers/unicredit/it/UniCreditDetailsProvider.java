...
@Service
public class UniCreditDetailsProvider implements AisDetailsProvider, PisDetailsProvider {

    public static final String UNICREDIT_SITE_ID = "eaeeadc1-4d27-4ae0-a9eb-e34ec0dbecc5";
    private static final String PROVIDER_KEY = "UNICREDIT";

    private static final List<AisSiteDetails> AIS_SITE_DETAILS = List.of(
            site(UNICREDIT_SITE_ID, "UniCredit", PROVIDER_KEY, DIRECT_CONNECTION, of(STATE), of(CURRENT_ACCOUNT, CREDIT_CARD), of(IT))
                    .groupingBy("UniCredit")
    ...
    private static final List<PisSiteDetails> PIS_SITE_DETAILS = List.of(
            PisSiteDetails.builder()
                    .id(UUID.fromString(UNICREDIT_SITE_ID))
