...
public class HypoVereinsbankBalanceMapper implements BalanceMapper {
    ...
    private ZonedDateTime parseDateTime(String dateTime) {
        return LocalDateTime.parse(dateTime, DateTimeFormatter.ISO_DATE_TIME).atZone(timeZoneId);
    }
