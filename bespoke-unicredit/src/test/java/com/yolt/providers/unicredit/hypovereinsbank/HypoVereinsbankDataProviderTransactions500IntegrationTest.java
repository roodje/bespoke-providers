...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/hypovereins/transactions-500", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class HypoVereinsbankDataProviderTransactions500IntegrationTest {
    ...
    @Test
    public void shouldThrowProviderFetchDataExceptionAccountForFetchDataWhenInternalServerErrorOnBalancesAPICall() {
        // given
