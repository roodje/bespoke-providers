...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/it/ais/transactions-500", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditItDataProviderTransactions500IntegrationTest {
    ...
    @Test
    public void shouldThrowProviderHttpStatusExceptionForFetchDataWhenInternalServerErrorOnBalancesAPICall() {
        // given
