...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/it/ais/accounts-401", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditItDataProviderAccounts401IntegrationTest {
    ...
    @Test
    public void shouldThrowProviderFetchDataExceptionForFetchDataWhenUnauthorizedErrorOnAccountsAPICall() {
        // given
