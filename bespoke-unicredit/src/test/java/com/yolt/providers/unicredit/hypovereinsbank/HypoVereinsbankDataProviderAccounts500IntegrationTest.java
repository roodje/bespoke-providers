...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/hypovereins/accounts-500", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class HypoVereinsbankDataProviderAccounts500IntegrationTest {
    ...
    @Test
    public void shouldThrowProviderFetchDataExceptionForFetchDataWhenInternalServerErrorOnAccountsAPICall() {
        // given
