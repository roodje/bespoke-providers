...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/it/pis/payment-status-400", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditItSepaPaymentProviderPaymentStatus400IntegrationTest {
    ...
    @Test
    public void shouldThrowConfirmationFailedExceptionForSubmitPaymentWhenBadRequestForGetStatusApiEndpoint() {
        // given
