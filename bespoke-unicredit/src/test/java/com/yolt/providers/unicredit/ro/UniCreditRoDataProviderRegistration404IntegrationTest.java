...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/ro/register-404", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditRoDataProviderRegistration404IntegrationTest {
