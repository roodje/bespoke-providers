...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/it/ais/accounts-500", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditItDataProviderAccounts500IntegrationTest {
    ...
    @Test
    public void shouldThrowProviderHttpStatusExceptionForFetchDataWhenInternalServerErrorOnAccountsAPICall() {
        // given
