...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/ro/balances-500", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditRoDataProviderBalances500IntegrationTest {
