...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/ro/transactions-500", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditRoDataProviderTransactions500IntegrationTest {
