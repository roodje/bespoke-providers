...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/it/ais/register-404", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditItDataProviderRegistration404IntegrationTest {
