...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/it/pis/initiate-payment-400", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class UniCreditItSepaPaymentProviderInitiatePayment400IntegrationTest {
    ...
    @Test
    public void shouldThrowCreationFailedExceptionForInitiatePaymentWhenBadRequestForInitiatePaymentApiEndpoint() {
        // given
