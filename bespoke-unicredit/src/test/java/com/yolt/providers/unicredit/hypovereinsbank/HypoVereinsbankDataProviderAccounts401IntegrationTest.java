...
@AutoConfigureWireMock(stubs = "classpath:/stubs/unicredit/hypovereins/accounts-401", httpsPort = 0, port = 0)
@ActiveProfiles("unicredit")
public class HypoVereinsbankDataProviderAccounts401IntegrationTest {
    ...
    @Test
    public void shouldThrowTokenInvalidExceptionForFetchDataWhenUnauthorizedErrorOnAccountsAPICall() {
        // given
