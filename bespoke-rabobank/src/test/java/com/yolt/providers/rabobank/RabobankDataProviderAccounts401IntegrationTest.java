 ...
 * Rabobank have a problem with token synchronization, it will return 401 even if token and consent is valid,
 * due to customer requests we mark it as failed fetch and don't invalidate token(so throw {@link ProviderFetchDataException})
 * <p>
...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/rabobank-ais/accounts-401/"}, httpsPort = 0, port = 0)
@Import(TestConfiguration.class)
@ActiveProfiles("rabobank")
class RabobankDataProviderAccounts401IntegrationTest {
