...
public class FabricGroupDataProviderGetAccountsHttp500IntegrationTest {
    ...
    void shouldThrowProviderFetchDataExceptionOnHttp500(FabricGroupDataProviderV1 dataProvider) {
        // given
        authenticationMeans = SampleAuthenticationMeans.getSampleAuthenticationMeans();
        String accessMeans = "{\"consentId\":\"500\",\"consentGeneratedAt\":1, \"consentValidTo\":\"2022-01-01\"}";
