...
class DefaultInitiatePaymentStatusesExtractorTest {
    ...
    private DefaultInitiatePaymentStatusesExtractor sut;
    ...
    void shouldReturnCorrectlyMappedPaymentStatusesForKnownStatusValue(final String status, final EnhancedPaymentStatus enhancedPaymentStatus) {
        // given
        var response = new InitiatePaymentResponse(status, null, null, null);
        sut = new DefaultInitiatePaymentStatusesExtractor(new DefaultCommonPaymentStatusMapper());
