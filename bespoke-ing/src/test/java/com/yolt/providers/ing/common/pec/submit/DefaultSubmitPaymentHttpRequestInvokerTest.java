...
class DefaultSubmitPaymentHttpRequestInvokerTest {


    private DefaultSubmitPaymentHttpRequestInvoker sut;
    ...
    void shouldReturnResponseEntityWithJsonNodeAsBodyForInvokeRequestWhenCorrectData() throws TokenInvalidException {
        ...
        sut =  new DefaultSubmitPaymentHttpRequestInvoker(httpClientFactory, new DefaultPisHttpClientErrorHandler(), "");
        ...
        given(httpClient.exchange(
                ...
                eq(ProviderClientEndpoints.SUBMIT_PAYMENT),
                eq(JsonNode.class),
