 ...
 * {@inheritDoc}
 *
 * @deprecated Use {@link DefaultSubmitPaymentHttpRequestInvokerV2} instead
 */
@Deprecated
@RequiredArgsConstructor
public class DefaultSubmitPaymentHttpRequestInvoker implements PaymentHttpRequestInvoker<Void, DefaultSubmitPaymentPreExecutionResult> {
