...
public class IngPaymentProviderV3 implements SepaPaymentProvider {

    private final String providerIdentifier;
    private final String providerIdentifierDisplayName;
    private final ProviderVersion version;

    private final SepaInitiateSinglePaymentExecutionContextAdapter<SepaCreditTransfer, InitiatePaymentResponse, DefaultInitiatePaymentPreExecutionResult> initiateSinglePaymentExecutionContextAdapter;
    private final SepaInitiateSinglePaymentExecutionContextAdapter<SepaCreditTransfer, InitiatePaymentResponse, DefaultInitiatePaymentPreExecutionResult> initiateScheduledPaymentExecutionContextAdapter;
    private final SepaInitiatePeriodicPaymentExecutionContextAdapter<SepaCreditTransfer, InitiatePaymentResponse, DefaultInitiatePaymentPreExecutionResult> initiatePeriodicPaymentExecutionContextAdapter;
    ...
    @Override
    public LoginUrlAndStateDTO initiateScheduledPayment(InitiatePaymentRequest initiatePaymentRequest) {
        return initiateScheduledPaymentExecutionContextAdapter.initiateSinglePayment(initiatePaymentRequest);
    }

    @Override
    public LoginUrlAndStateDTO initiatePeriodicPayment(InitiatePaymentRequest initiatePeriodicPaymentRequest) {
        return initiatePeriodicPaymentExecutionContextAdapter.initiatePeriodicPayment(initiatePeriodicPaymentRequest);
    }
