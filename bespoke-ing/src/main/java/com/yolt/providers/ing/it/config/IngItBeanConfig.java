...
@Configuration
public class IngItBeanConfig {

    @Bean("IngItDataProviderV10")
    public IngDataProviderV9 getDataProviderV10(IngItProperties properties, Clock clock) {
        ...
        IngFetchDataService fetchDataService = new IngFetchDataServiceV9(new IngDataMapperServiceV6(IngItProperties.ZONE_ID), restTemplateService, ingSigningUtil, properties, clock);
        IngAuthenticationServiceV3 authenticationService = new IngAuthenticationServiceV3(restTemplateService, ingSigningUtil, properties, IngItProperties.COUNTRY_CODE, clock);
        return new IngDataProviderV9(
                fetchDataService,
                authenticationService,
                IngObjectMapper.get(),
                IngItProperties.PROVIDER_IDENTIFIER,
                IngItProperties.PROVIDER_IDENTIFIER_DISPLAY_NAME,
                ProviderVersion.VERSION_10,
                clock);
    }

    @Bean("IngItPaymentProviderV2")
    public IngPaymentProviderV2 getPaymentProviderV2(final IngItProperties properties,
        ...
        String providerIdentifier = IngItProperties.PROVIDER_IDENTIFIER;
        clock.withZone(ZoneId.of("Europe/Rome"));
