...
class YoltBankUkInitiateScheduledPaymentPaymentHttpRequestInvokerTest {

    @InjectMocks
    private YoltBankUkInitiateScheduledPaymentPaymentHttpRequestInvoker httpRequestInvoker;
    ...
    void shouldReturnResponseEntityWithJsonNodeAsBodyForInvokeRequest() {
        // given
        HttpEntity<OBWriteDomesticScheduledConsent1> httpEntity = Mockito.mock(HttpEntity.class);
        ResponseEntity<JsonNode> responseEntity = ResponseEntity.ok(mock(JsonNode.class));
        given(httpService.postInitiateScheduledPayment(httpEntity))
