...
public class YoltBankSepaPeriodicPaymentProviderStateExtractorTest {

    @InjectMocks
    private YoltBankSepaPeriodicPaymentProviderStateExtractor providerStateExtractor;
    ...
    void shouldReturnProperProviderState() throws JsonProcessingException {
        ...
        given(objectMapper.writeValueAsString(new SepaProviderState("", PaymentType.PERIODIC)))
