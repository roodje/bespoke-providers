...
public class YoltBankSepaInitiatePeriodicPaymentPreExecutionResultMapperTest {

    private YoltBankSepaInitiatePeriodicPaymentPreExecutionResultMapper mapper;

    @BeforeEach
    public void setup() {
        mapper = new YoltBankSepaInitiatePeriodicPaymentPreExecutionResultMapper();
    }
