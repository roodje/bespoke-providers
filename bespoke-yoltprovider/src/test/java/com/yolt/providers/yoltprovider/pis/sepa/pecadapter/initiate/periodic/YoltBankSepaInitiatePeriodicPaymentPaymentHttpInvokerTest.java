...
public class YoltBankSepaInitiatePeriodicPaymentPaymentHttpInvokerTest {

    @InjectMocks
    private YoltBankSepaInitiatePeriodicPaymentPaymentHttpInvoker paymentHttpInvoker;
    ...
    void shouldReturnResponseEntityWithJsonNodeAsBodyForInvokeRequest() {
        ...
        given(httpService.postInitiatePeriodicPaymentRequest(httpEntity))
