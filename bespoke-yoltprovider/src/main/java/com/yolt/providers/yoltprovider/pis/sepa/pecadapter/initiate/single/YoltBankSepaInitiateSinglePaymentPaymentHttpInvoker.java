...
public class YoltBankSepaInitiateSinglePaymentPaymentHttpInvoker implements PaymentHttpRequestInvoker<byte[], YoltBankSepaInitiatePaymentPreExecutionResult> {
    ...
    public ResponseEntity<JsonNode> invokeRequest(HttpEntity<byte[]> httpEntity, YoltBankSepaInitiatePaymentPreExecutionResult preExecutionResult) {
        return httpService.postInitiateSinglePaymentRequest(httpEntity);
    }
}
