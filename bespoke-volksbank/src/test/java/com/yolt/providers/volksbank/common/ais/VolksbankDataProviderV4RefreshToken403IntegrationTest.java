...
/**
 * This test suite contains case when 403 error is returned when refreshing access token for Volksbank group providers.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/volksbank/api_1.1/ais/refresh_token_403", port = 0, httpsPort = 0)
@ActiveProfiles("volksbank")
public class VolksbankDataProviderV4RefreshToken403IntegrationTest {
