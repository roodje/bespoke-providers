...
@AutoConfigureWireMock(httpsPort = 0, port = 0, stubs = {"classpath:/stubs/volksbank/api_1.1/pis/payment_status_500"})
public class VolksbankSepaPaymentProviderV3PaymentStatus500IntegrationTest {
    ...
    public void shouldReturnResponseWithEmptyPaymentIdAndProperStatusesInPecMetadataForSubmitPaymentWhen500ErrorWhilePaymentStatusRequest(SepaPaymentProvider paymentProviderUnderTest) {
        // given
        ...
        assertThat(result.getPaymentExecutionContextMetadata()).satisfies(pecMetadata -> assertThat(pecMetadata.getPaymentStatuses()).extracting(statuses -> statuses.getRawBankPaymentStatus().getStatus(),
                ...
                .contains("INTERNAL_SERVER_ERROR", "An internal server error occurred.", EnhancedPaymentStatus.UNKNOWN));
    }
}
