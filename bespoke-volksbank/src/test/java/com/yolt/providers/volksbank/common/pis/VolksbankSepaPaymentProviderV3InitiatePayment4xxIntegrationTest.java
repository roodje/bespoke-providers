...
@AutoConfigureWireMock(httpsPort = 0, port = 0, stubs = { "classpath:/stubs/volksbank/api_1.1/pis/initiate_payment_4xx" })
public class VolksbankSepaPaymentProviderV3InitiatePayment4xxIntegrationTest {
    ...
    public void shouldReturnResponseWithEmptyLoginUrlAndEmptyProviderStateAndProperStatusesInPecMetadataForInitiatePaymentWhen4xxError(SepaPaymentProvider paymentProviderUnderTest) {
        // given
        ...
        assertThat(result.getPaymentExecutionContextMetadata()).satisfies(pecMetadata ->
                assertThat(pecMetadata.getPaymentStatuses()).extracting(statuses -> statuses.getRawBankPaymentStatus().getStatus(),
                        ...
                        .contains("FORMAT_ERROR",
                                "The format of the input is not valid.",
