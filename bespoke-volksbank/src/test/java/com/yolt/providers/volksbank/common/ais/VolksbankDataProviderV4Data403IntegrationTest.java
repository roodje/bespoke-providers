...
/**
 * This test suite contains case when 403 error is returned from data endpoint in Volksbank group providers.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/volksbank/api_1.1/ais/data_403", port = 0, httpsPort = 0)
@ActiveProfiles("volksbank")
public class VolksbankDataProviderV4Data403IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenFetchingData(UrlDataProvider dataProviderUnderTest) throws JsonProcessingException {
        //given
        ...
        // then
        assertThatExceptionOfType(TokenInvalidException.class).isThrownBy(throwingCallable).withMessage("Access to call is forbidden: HTTP 403");
    }
