...
/**
 * This test suite contains case when 401 error is returned from data endpoint in Volksbank group providers.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/volksbank/api_1.1/ais/data_401", port = 0, httpsPort = 0)
@ActiveProfiles("volksbank")
public class VolksbankDataProviderV4Data401IntegrationTest {
