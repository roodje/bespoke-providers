...
/**
 * This test suite contains case when 400 error is returned from data endpoint in Volksbank group providers.
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/volksbank/api_1.1/ais/data_400", port = 0, httpsPort = 0)
@ActiveProfiles("volksbank")
public class VolksbankDataProviderV4Data400IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenConsentFailedErrorOccur(UrlDataProvider dataProviderUnderTest) throws JsonProcessingException {
        //given
        ...
        //when
        final ThrowableAssert.ThrowingCallable throwingCallable = () -> dataProviderUnderTest.fetchData(urlFetchData);
        // then
        assertThatExceptionOfType(TokenInvalidException.class).isThrownBy(throwingCallable).withMessage("Error with status code: 400 Consent call failed");
    }
