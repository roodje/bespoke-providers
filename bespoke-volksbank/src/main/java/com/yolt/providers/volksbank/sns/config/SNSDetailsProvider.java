...
@Service
public class SNSDetailsProvider implements AisDetailsProvider, PisDetailsProvider {

    public static final String SNS_SITE_ID = "13c00f7c-9746-11e9-bc42-526af7764f64";
    private static final String PROVIDER_KEY = "SNS_BANK";

    private static final List<AisSiteDetails> AIS_SITE_DETAILS = List.of(
            site(SNS_SITE_ID, "SNS Bank", PROVIDER_KEY, DIRECT_CONNECTION, of(STATE), of(CURRENT_ACCOUNT), of(NL))
                    .groupingBy("SNS Bank")
    ...
    private static final List<PisSiteDetails> PIS_SITE_DETAILS = List.of(
            PisSiteDetails.builder()
                    .id(UUID.fromString(SNS_SITE_ID))
