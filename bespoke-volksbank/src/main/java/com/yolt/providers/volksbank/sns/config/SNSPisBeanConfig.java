...
@Configuration
public class SNSPisBeanConfig {

    private static final String IDENTIFIER = "SNS_BANK";
    private static final String DISPLAY_NAME = "SNS Bank";

    @Bean("SNSBankSepaPaymentProviderV3")
    public VolksbankSepaPaymentProviderV3 snsSepaPaymentProviderV3(@Qualifier("Volksbank") final ObjectMapper objectMapper,
