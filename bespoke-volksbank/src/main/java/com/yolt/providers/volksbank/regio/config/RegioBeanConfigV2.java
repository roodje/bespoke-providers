...
@Configuration
public class RegioBeanConfigV2 {

    private static final String IDENTIFIER = "REGIO_BANK";
    private static final String DISPLAY_NAME = "Regio Bank";

    @Bean("RegioDataProviderV5")
    public VolksbankDataProviderV4 getRegioDataProviderV5(@Qualifier("Volksbank") final ObjectMapper objectMapper,
    ...
    public VolksbankFetchDataServiceV4 getFetchDataServiceV4(final RegioProperties properties, final Clock clock) {
