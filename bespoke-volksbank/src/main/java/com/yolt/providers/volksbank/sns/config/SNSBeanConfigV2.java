...
@Configuration
public class SNSBeanConfigV2 {

    private static final String IDENTIFIER = "SNS_BANK";
    private static final String DISPLAY_NAME = "SNS Bank";

    @Bean("SNSDataProviderV5")
    public VolksbankDataProviderV4 getSNSDataProviderV5(@Qualifier("Volksbank") final ObjectMapper objectMapper,
                                                        final SNSProperties properties,
    ...
    public VolksbankFetchDataServiceV4 getFetchDataServiceV4(final SNSProperties properties, final Clock clock) {
