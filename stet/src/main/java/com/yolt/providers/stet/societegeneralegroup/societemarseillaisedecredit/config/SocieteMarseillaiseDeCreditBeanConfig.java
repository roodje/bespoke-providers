package com.yolt.providers.stet.societegeneralegroup.societemarseillaisedecredit.config;
...
import static com.yolt.providers.stet.societegeneralegroup.societemarseillaisedecredit.SocieteMarseillaiseDeCreditDetailsProvider.PROVIDER_KEY;
import static com.yolt.providers.stet.societegeneralegroup.societemarseillaisedecredit.SocieteMarseillaiseDeCreditDetailsProvider.PROVIDER_NAME;

@Configuration("SocieteMarseillaiseDeCreditBeanConfig")
public class SocieteMarseillaiseDeCreditBeanConfig {

    @Bean("SocieteMarseillaiseDeCreditDataProviderV1")
    public SocieteGeneraleGroupDataProvider SocieteMarseillaiseDeCreditDataProviderV1(MeterRegistry meterRegistry,
                                                                                      Clock clock,
                                                                                      @Qualifier("SocieteMarseillaiseDeCreditProperties") SocieteMarseillaiseDeCreditProperties properties,
