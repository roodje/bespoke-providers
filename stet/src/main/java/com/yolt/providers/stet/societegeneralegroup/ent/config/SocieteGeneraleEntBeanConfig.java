...
@Configuration("SocieteGeneraleEntBeanConfig")
public class SocieteGeneraleEntBeanConfig {

    private static final String PROVIDER_IDENTIFIER = "SOCIETE_GENERALE_ENT";
    private static final String PROVIDER_DISPLAY_NAME = "Societe Generale Entreprises";

    @Bean("SocieteGeneraleEntDataProviderV5")
    public SocieteGeneraleGroupDataProvider societeGeneraleEntDataProviderV5(MeterRegistry meterRegistry,
                                                                             Clock clock,
                                                                             @Qualifier("SocieteGeneraleEntStetProperties") SocieteGeneraleEntProperties properties,
    ...
    @Bean("SocieteGeneraleEntPaymentProviderV5")
    public GenericPaymentProviderV3 createSocieteGeneraleEntPaymentProviderV5(MeterRegistry meterRegistry,
                                                                              Clock clock,
                                                                              @Qualifier("SocieteGeneraleEntStetProperties") SocieteGeneraleEntProperties properties,
                                                                              @Qualifier("StetObjectMapper") ObjectMapper objectMapper) {
        ObjectMapper societeGeneraleEntObjectMapper = objectMapper.copy();
        return new SocieteGeneraleGroupPaymentProviderFactory(
                ...
                ConsentValidityRules.EMPTY_RULES_SET,
                societeGeneraleEntObjectMapper,
                clock,
                properties,
                new DefaultHttpClientFactoryV2(meterRegistry, societeGeneraleEntObjectMapper),
