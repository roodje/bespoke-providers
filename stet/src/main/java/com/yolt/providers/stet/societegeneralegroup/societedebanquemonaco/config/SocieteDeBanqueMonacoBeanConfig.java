...
import static com.yolt.providers.stet.societegeneralegroup.societedebanquemonaco.SocieteDeBanqueMonacoDetailsProvider.PROVIDER_KEY;
import static com.yolt.providers.stet.societegeneralegroup.societedebanquemonaco.SocieteDeBanqueMonacoDetailsProvider.PROVIDER_NAME;

@Configuration("SocieteDeBanqueMonacoBeanConfig")
public class SocieteDeBanqueMonacoBeanConfig {

    @Bean("SocieteDeBanqueMonacoDataProviderV1")
    public SocieteGeneraleGroupDataProvider SocieteDeBanqueMonacoDataProviderV1(MeterRegistry meterRegistry,
                                                                                Clock clock,
                                                                                @Qualifier("SocieteDeBanqueMonacoProperties") SocieteDeBanqueMonacoProperties properties,
