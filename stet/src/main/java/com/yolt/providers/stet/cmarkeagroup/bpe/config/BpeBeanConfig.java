...
@Configuration("BpeStetBeanConfig")
public class BpeBeanConfig {
    private static final Period FETCH_PERIOD = Period.ofDays(89);
    private static final ZoneId ZONE_ID = ZoneId.of("Europe/Paris");

    @Bean("BpeDataProviderV1")
    public CmArkeaGroupDataProvider createBpeDataProviderV1(MeterRegistry meterRegistry,
                                                            Clock clock,
                                                            @Qualifier("BpeStetProperties") BpeProperties properties,
