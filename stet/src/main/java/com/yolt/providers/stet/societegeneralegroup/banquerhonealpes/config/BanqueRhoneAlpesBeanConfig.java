...
import static com.yolt.providers.stet.societegeneralegroup.banquerhonealpes.BanqueRhoneAlpesDetailsProvider.PROVIDER_KEY;
import static com.yolt.providers.stet.societegeneralegroup.banquerhonealpes.BanqueRhoneAlpesDetailsProvider.PROVIDER_NAME;

@Configuration("BanqueRhoneAlpesBeanConfig")
public class BanqueRhoneAlpesBeanConfig {

    @Bean("BanqueRhoneAlpesDataProviderV1")
    public SocieteGeneraleGroupDataProvider BanqueRhoneAlpesDataProviderV1(MeterRegistry meterRegistry,
                                                                           Clock clock,
                                                                           @Qualifier("BanqueRhoneAlpesProperties") BanqueRhoneAlpesProperties properties,
