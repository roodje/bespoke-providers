...
@Configuration("CreditMutuelDuSudOuestStetBeanConfig")
public class CreditMutuelDuSudOuestBeanConfig {
    private static final Period FETCH_PERIOD = Period.ofDays(89);
    private static final ZoneId ZONE_ID = ZoneId.of("Europe/Paris");

    @Bean("CreditMutuelDuSudOuestDataProviderV1")
    public CmArkeaGroupDataProvider createCreditMutuelDuSudOuestDataProviderV1(MeterRegistry meterRegistry,
                                                                               Clock clock,
                                                                               @Qualifier("CreditMutuelDuSudOuestStetProperties") CreditMutuelDuSudOuestProperties properties,
