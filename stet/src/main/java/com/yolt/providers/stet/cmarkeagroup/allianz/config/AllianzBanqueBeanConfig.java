...
@Configuration("AllianzBanqueStetBeanConfig")
public class AllianzBanqueBeanConfig {
    private static final Period FETCH_PERIOD = Period.ofDays(89);
    private static final ZoneId ZONE_ID = ZoneId.of("Europe/Paris");

    @Bean("AllianzBanqueDataProviderV1")
    public CmArkeaGroupDataProvider createAllianzBanqueDataProviderV1(MeterRegistry meterRegistry,
                                                                      Clock clock,
                                                                      @Qualifier("AllianzBanqueStetProperties") AllianzBanqueProperties properties,
