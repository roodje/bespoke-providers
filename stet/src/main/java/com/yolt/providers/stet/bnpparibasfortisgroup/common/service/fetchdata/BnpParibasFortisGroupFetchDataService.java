...
public class BnpParibasFortisGroupFetchDataService extends DefaultFetchDataService {

    private static final String ACCOUNTS_ENDPOINT = "/psd2/v2/accounts";
    private static final String BALANCES_TEMPLATE = "/psd2/v2/accounts/{accountId}/balances";
    private static final String TRANSACTIONS_TEMPLATE = "/psd2/v2/accounts/{accountId}/transactions";

    public BnpParibasFortisGroupFetchDataService(FetchDataRestClient restClient, ProviderStateMapper providerStateMapper, FetchAccountsStrategy fetchAccountsStrategy, FetchTransactionsStrategy fetchTransactionsStrategy, FetchBalancesStrategy fetchBalancesStrategy, DateTimeSupplier dateMapper, AccountMapper accountMapper, TransactionMapper transactionMapper, DefaultProperties properties) {
