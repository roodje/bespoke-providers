...
@Configuration("ArkeaBanqueEntreprisesStetBeanConfig")
public class ArkeaBanqueEntreprisesBeanConfig {
    private static final Period FETCH_PERIOD = Period.ofDays(89);
    private static final ZoneId ZONE_ID = ZoneId.of("Europe/Paris");

    @Bean("ArkeaBanqueEntreprisesDataProviderV1")
    public CmArkeaGroupDataProvider createArkeaBanqueEntreprisesDataProviderV1(MeterRegistry meterRegistry,
                                                                               Clock clock,
                                                                               @Qualifier("ArkeaBanqueEntreprisesStetProperties") ArkeaBanqueEntreprisesProperties properties,
