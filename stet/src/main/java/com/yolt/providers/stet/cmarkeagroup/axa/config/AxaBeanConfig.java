...
@Configuration("AxaStetBeanConfig")
public class AxaBeanConfig {

    private static final Period FETCH_PERIOD = Period.ofDays(89);
    private static final ZoneId ZONE_ID = ZoneId.of("Europe/Paris");

    @Bean("AxaDataProviderV3")
    public CmArkeaGroupDataProvider createAxaDataProviderV3(MeterRegistry meterRegistry,
                                                            Clock clock,
                                                            @Qualifier("AxaStetProperties") AxaProperties properties,
