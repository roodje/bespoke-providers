package com.yolt.providers.stet.cmarkeagroup.cmdebretagne.config;
...
@Configuration("CreditMutuelDeBretagneStetBeanConfig")
public class CreditMutuelDeBretagneBeanConfig {
    private static final Period FETCH_PERIOD = Period.ofDays(89);
    private static final ZoneId ZONE_ID = ZoneId.of("Europe/Paris");

    @Bean("CreditMutuelDeBretagneDataProviderV1")
    public CmArkeaGroupDataProvider createArkeaBanquePriveeDataProviderV1(MeterRegistry meterRegistry,
                                                                          Clock clock,
                                                                          @Qualifier("CreditMutuelDeBretagneStetProperties") CreditMutuelDeBretagneProperties properties,
