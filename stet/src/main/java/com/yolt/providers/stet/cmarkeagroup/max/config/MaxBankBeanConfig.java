...
@Configuration("MaxBankStetBeanConfig")
public class MaxBankBeanConfig {
    private static final Period FETCH_PERIOD = Period.ofDays(89);
    private static final ZoneId ZONE_ID = ZoneId.of("Europe/Paris");

    @Bean("MaxBankDataProviderV1")
    public CmArkeaGroupDataProvider createMaxBankDataProviderV1(MeterRegistry meterRegistry,
                                                                Clock clock,
                                                                @Qualifier("MaxBankStetProperties") MaxBankProperties properties,
