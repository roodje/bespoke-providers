...
@Configuration("ArkeaBankingServicesStetBeanConfig")
public class ArkeaBankingServicesBeanConfig {
    private static final Period FETCH_PERIOD = Period.ofDays(89);
    private static final ZoneId ZONE_ID = ZoneId.of("Europe/Paris");

    @Bean("ArkeaBankingServicesDataProviderV1")
    public CmArkeaGroupDataProvider createArkeaBankingServicesDataProviderV1(MeterRegistry meterRegistry,
                                                                             Clock clock,
                                                                             @Qualifier("ArkeaBankingServicesStetProperties") ArkeaBankingServicesProperties properties,
