package com.yolt.providers.stet.societegeneralegroup.societedebanquemonaco;
...
@Service
public class SocieteDeBanqueMonacoDetailsProvider implements AisDetailsProvider {

    public static final String SITE_ID = "595eed85-f062-4b1c-a57a-87a5a340b7fc";
    public static final String PROVIDER_NAME = "Société de Banque Monaco";
    public static final String PROVIDER_KEY = "SOCIETE_DE_BANQUE_MONACO";
