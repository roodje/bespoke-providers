...
import com.yolt.providers.stet.cicgroup.creditmutuel.service.fetchdata.CreditMutuelFetchDataService;
...
@Configuration("CreditMutuelStetBeanConfig")
public class CreditMutuelBeanConfig {

    @Bean("CreditMutuelDataProviderV7")
    public CreditMutuelDataProviderV7 createCreditMutuelDataProviderV7(@Qualifier("CreditMutuelStetProperties") CreditMutuelProperties properties,
        ...
        return new CreditMutuelDataProviderV7(
                authMeansSupplier,
                ...
                new SingleRegionAuthorizationService(
                        new RefreshTokenSupportedStrategy(providerStateMapper,
                                Scope.AISP,
                        ...
                        cicGroupDateTimeSupplier),
                new CreditMutuelFetchDataService(
                        fetchDataRestClient,
                        providerStateMapper,
