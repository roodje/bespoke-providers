...
import static com.yolt.providers.stet.societegeneralegroup.banquecourtois.BanqueCourtoisDetailsProvider.PROVIDER_KEY;
import static com.yolt.providers.stet.societegeneralegroup.banquecourtois.BanqueCourtoisDetailsProvider.PROVIDER_NAME;


@Configuration("BanqueCourtoisBeanConfig")
public class BanqueCourtoisBeanConfig {

    @Bean("BanqueCourtoisDataProviderV1")
    public SocieteGeneraleGroupDataProvider BanqueCourtoisDataProviderV1(MeterRegistry meterRegistry,
                                                                         Clock clock,
                                                                         @Qualifier("BanqueCourtoisProperties") BanqueCourtoisProperties properties,
