...
import static com.yolt.providers.stet.societegeneralegroup.banquelaydernier.BanqueLaydernierDetailsProvider.PROVIDER_KEY;
import static com.yolt.providers.stet.societegeneralegroup.banquelaydernier.BanqueLaydernierDetailsProvider.PROVIDER_NAME;

@Configuration("BanqueLaydernierBeanConfig")
public class BanqueLaydernierBeanConfig {

    @Bean("BanqueLaydernierDataProviderV1")
    public SocieteGeneraleGroupDataProvider BanqueLaydernierDataProviderV1(MeterRegistry meterRegistry,
                                                                           Clock clock,
                                                                           @Qualifier("BanqueLaydernierProperties") BanqueLaydernierProperties properties,
