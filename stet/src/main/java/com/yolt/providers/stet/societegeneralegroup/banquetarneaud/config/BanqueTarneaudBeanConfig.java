...
import static com.yolt.providers.stet.societegeneralegroup.banquetarneaud.BanqueTarneaudDetailsProvider.PROVIDER_KEY;
import static com.yolt.providers.stet.societegeneralegroup.banquetarneaud.BanqueTarneaudDetailsProvider.PROVIDER_NAME;

@Configuration("BanqueTarneaudBeanConfig")
public class BanqueTarneaudBeanConfig {

    @Bean("BanqueTarneaudDataProviderV1")
    public SocieteGeneraleGroupDataProvider BanqueTarneaudDataProviderV1(MeterRegistry meterRegistry,
                                                                         Clock clock,
                                                                         @Qualifier("BanqueTarneaudProperties") BanqueTarneaudProperties properties,
