...
public class GenericPaymentProviderV3 implements SepaPaymentProvider {

    private final ProviderIdentification identification;
    private final SepaInitiateSinglePaymentExecutionContextAdapter<StetPaymentInitiationRequestDTO, StetPaymentInitiationResponseDTO, StetInitiatePreExecutionResult> initiatePaymentExecutionContextAdapter;
    ...
    public LoginUrlAndStateDTO initiatePayment(InitiatePaymentRequest request) {
        return initiatePaymentExecutionContextAdapter.initiateSinglePayment(request);
    }
