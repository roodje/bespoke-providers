...
@Configuration("SocieteGeneralePriBeanConfig")
public class SocieteGeneralePriBeanConfig {

    private static final String PROVIDER_IDENTIFIER = "SOCIETE_GENERALE_PRI";
    private static final String PROVIDER_DISPLAY_NAME = "Societe Generale Particuliers";

    @Bean("SocieteGeneralePriDataProviderV6")
    public SocieteGeneraleGroupDataProvider SocieteGeneralePriDataProviderV5(MeterRegistry meterRegistry,
                                                                             Clock clock,
                                                                             @Qualifier("SocieteGeneralePriStetProperties") SocieteGeneralePriProperties properties,
        ...
        return new SocieteGeneraleGroupDataProvider(new ProviderIdentification(PROVIDER_IDENTIFIER, PROVIDER_DISPLAY_NAME, ProviderVersion.VERSION_6),
                authMeansSupplier,
    ...
    @Bean("SocieteGeneralePriPaymentProviderV5")
    public GenericPaymentProviderV3 createSocieteGeneralePriPaymentProviderV5(MeterRegistry meterRegistry,
                                                                              Clock clock,
                                                                              @Qualifier("SocieteGeneralePriStetProperties") SocieteGeneralePriProperties properties,
                                                                              @Qualifier("StetObjectMapper") ObjectMapper objectMapper) {
        ObjectMapper societeGeneralePriObjectMapper = objectMapper.copy();
        return new SocieteGeneraleGroupPaymentProviderFactory(
                ...
                ConsentValidityRules.EMPTY_RULES_SET,
                societeGeneralePriObjectMapper,
                clock,
                properties,
                new DefaultHttpClientFactoryV2(meterRegistry, societeGeneralePriObjectMapper),
