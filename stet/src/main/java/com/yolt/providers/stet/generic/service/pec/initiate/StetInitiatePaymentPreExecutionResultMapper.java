...
@Deprecated
public class StetInitiatePaymentPreExecutionResultMapper<TokenPaymentPreExecutionResult> implements SepaInitiatePaymentPreExecutionResultMapper<StetInitiatePreExecutionResult> {
    ...
    public StetInitiatePaymentPreExecutionResultMapper(AuthenticationMeansSupplier authenticationMeansSupplier,
