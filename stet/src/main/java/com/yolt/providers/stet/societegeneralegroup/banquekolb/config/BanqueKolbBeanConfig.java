...
import static com.yolt.providers.stet.societegeneralegroup.banquekolb.BanqueKolbDetailsProvider.PROVIDER_KEY;
import static com.yolt.providers.stet.societegeneralegroup.banquekolb.BanqueKolbDetailsProvider.PROVIDER_NAME;


@Configuration("BanqueKolbBeanConfig")
public class BanqueKolbBeanConfig {

    @Bean("BanqueKolbDataProviderV1")
    public SocieteGeneraleGroupDataProvider BanqueKolbDataProviderV1(MeterRegistry meterRegistry,
                                                                     Clock clock,
                                                                     @Qualifier("BanqueKolbProperties") BanqueKolbProperties properties,
