package com.yolt.providers.stet.societegeneralegroup.banquekolb;
...
@Service
public class BanqueKolbDetailsProvider implements AisDetailsProvider {

    public static final String SITE_ID = "662e2200-1e75-4586-b827-10df46f270ef";
    public static final String PROVIDER_NAME = "Banque Kolb";
    public static final String PROVIDER_KEY = "BANQUE_KOLB";
