package com.yolt.providers.stet.cicgroup.creditmutuel.service.fetchdata;
...
public class CreditMutuelFetchDataService extends DefaultFetchDataService {

    protected static final String ACCOUNTS_ENDPOINT = "/cm/stet-psd2-api/v2.1/accounts";
    protected static final String BALANCES_TEMPLATE = "/cm/stet-psd2-api/v2.1/accounts/{accountId}/balances";
    protected static final String TRANSACTIONS_TEMPLATE = "/cm/stet-psd2-api/v2.1/accounts/{accountId}/transactions";

    public CreditMutuelFetchDataService(FetchDataRestClient restClient, ProviderStateMapper providerStateMapper, FetchAccountsStrategy fetchAccountsStrategy, FetchTransactionsStrategy fetchTransactionsStrategy, FetchBalancesStrategy fetchBalancesStrategy, DateTimeSupplier dateMapper, AccountMapper accountMapper, TransactionMapper transactionMapper, DefaultProperties properties) {
