...
import static com.yolt.providers.stet.societegeneralegroup.creditdunord.CreditDuNordDetailsProvider.PROVIDER_KEY;
import static com.yolt.providers.stet.societegeneralegroup.creditdunord.CreditDuNordDetailsProvider.PROVIDER_NAME;

@Configuration("CreditDuNordBeanConfig")
public class CreditDuNordBeanConfig {

    @Bean("CreditDuNordDataProviderV1")
    public SocieteGeneraleGroupDataProvider CreditDuNordDataProviderV1(MeterRegistry meterRegistry,
                                                                       Clock clock,
                                                                       @Qualifier("CreditDuNordProperties") CreditDuNordProperties properties,
