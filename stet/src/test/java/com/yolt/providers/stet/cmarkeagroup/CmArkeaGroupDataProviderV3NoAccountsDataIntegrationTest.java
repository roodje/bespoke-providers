...
public class CmArkeaGroupDataProviderV3NoAccountsDataIntegrationTest {
    ...
    public void shouldReturnResponseWithNoAccount(UrlDataProvider dataProvider) throws ProviderFetchDataException, TokenInvalidException {
        // given
        String accessMeans = "{\"expires_in\":3600,\"access_token\":\"accessToken123456703\",\"refresh_token\":\"refresh-token\", \"refreshed\":\"false\"}";
