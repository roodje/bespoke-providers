...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/bnpparibasgroup/ais/invalid-token"}, httpsPort = 0, port = 0)
class BnpParibasGroupDataProvidersUnauthorizedAccessTokenIntegrationTest {
    ...
    void shouldThrowTokenInvalidExceptionWhenReceivedHttp401OnAccountsEndpoint(BnpParibasGroupDataProvider dataProvider) throws JsonProcessingException {
        // given
        UrlFetchDataRequest urlFetchDataRequest = new UrlFetchDataRequestBuilder()
                ...
                .setAccessMeans(sampleAccessMeans.createAccessMeans(BnpParibasGroupTestsConstants.ACCESS_TOKEN_INVALID, BnpParibasGroupTestsConstants.USER_ID))
        ...
        assertThatThrownBy(fetchDataCallable).isInstanceOf(TokenInvalidException.class)
                .withFailMessage("Failed fetching data for multiple accounts, failedAccountsSize=1");
    }
}
