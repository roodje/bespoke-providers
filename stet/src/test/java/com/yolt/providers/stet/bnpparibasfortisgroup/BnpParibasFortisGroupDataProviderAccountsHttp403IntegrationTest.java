...
@AutoConfigureWireMock(stubs = "classpath:/stubs/bnpparibasfortis-2.0.1/accounts-403/", httpsPort = 0, port = 0)
@Import(BnpParibasFortisTestConfig.class)
@ActiveProfiles("bnpparibasfortis")
class BnpParibasFortisGroupDataProviderAccountsHttp403IntegrationTest {
    ...
    @Test
    void shouldThrowTokenInvalidExceptionWhenAccountsRequestFail() {
        // given
