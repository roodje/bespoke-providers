...
@AutoConfigureWireMock(stubs = {
        "classpath:/stubs/boursorama/pis/payment-status-400",
        "classpath:/stubs/boursorama/pis/happy-flow/token"}, httpsPort = 0, port = 0)
public class BoursoramaPaymentProviderV3PaymentConfirmation400IntegrationTest {

    private static final String PAYMENT_ID = "AyAmAIAfId";
    ...
    public void shouldThrowPaymentExecutionTechnicalExceptionForGetPaymentStatusWhen4xxError(SepaPaymentProvider sepaPaymentProvider) {
        // given
    ...
    @ParameterizedTest
    @MethodSource("getBoursoramaProviders")
    public void shouldReturnEmptyPaymentIdAndRejectedPaymentStatusAndProperStatusesInPecMetadataForSubmitPaymentWhen4xxError(SepaPaymentProvider sepaPaymentProvider) {
        // given
