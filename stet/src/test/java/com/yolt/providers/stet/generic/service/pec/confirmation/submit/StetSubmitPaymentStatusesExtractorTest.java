...
public class StetSubmitPaymentStatusesExtractorTest {

    private StetSubmitPaymentStatusesExtractor statusPaymentStatusesExtractor;

    @BeforeEach
    void initialize() {
        statusPaymentStatusesExtractor = new StetSubmitPaymentStatusesExtractor();
    }
