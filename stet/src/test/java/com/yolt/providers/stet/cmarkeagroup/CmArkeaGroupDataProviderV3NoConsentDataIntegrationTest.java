...
public class CmArkeaGroupDataProviderV3NoConsentDataIntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionWhenResponseIsHttp403(UrlDataProvider dataProvider) {
        // given
        String accessMeans = "{\"expires_in\":3600,\"access_token\":\"accessToken123456705\",\"refresh_token\":\"refresh-token\", \"refreshed\":\"false\"}";
        ...
        // when
        assertThatThrownBy(() -> dataProvider.fetchData(request)).isInstanceOf(TokenInvalidException.class)
