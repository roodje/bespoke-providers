...
@AutoConfigureWireMock(stubs = {
        "classpath:/stubs/boursorama/pis/initiate-payment-500",
        "classpath:/stubs/boursorama/pis/happy-flow/token"}, httpsPort = 0, port = 0)
public class BoursoramaPaymentProviderV3InitiatePayment500IntegrationTest {
    ...
    public void shouldReturnEmptyLoginUrlAndEmptyProviderStateAndProperStatusesInPecMetadataForInitiatePaymentWhen5xxError(SepaPaymentProvider paymentProviderUnderTest) {
        // given
        ...
        assertThat(loginUrlAndStateDTO.getPaymentExecutionContextMetadata())
                .satisfies(pecMetadata -> assertThat(pecMetadata.getPaymentStatuses())
                        ...
                        .contains("Internal Server Error", "An internal server error occurred", INITIATION_ERROR));
    }
}
