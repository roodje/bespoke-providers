...
@AutoConfigureWireMock(stubs = "classpath:/stubs/bnpparibasfortis-2.0.1/accounts-401/", httpsPort = 0, port = 0)
@Import(BnpParibasFortisTestConfig.class)
@ActiveProfiles("bnpparibasfortis")
class BnpParibasFortisGroupDataProviderAccountsHttp401IntegrationTest {
    ...
    @Test
    void shouldThrowTokenInvalidExceptionWhenReceivedHttp401OnAccountsEndpoint() {
        // given
