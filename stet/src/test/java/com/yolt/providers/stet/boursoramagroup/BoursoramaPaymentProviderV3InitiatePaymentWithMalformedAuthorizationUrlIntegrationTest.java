...
/**
 * This test contains flow for scenarios when we get a malformed consent approval URL from the response
 * It occurs during payment initiation process
...
@AutoConfigureWireMock(stubs = {
        "classpath:/stubs/boursorama/pis/initiate-payment-malformed-authorization-url",
        "classpath:/stubs/boursorama/pis/happy-flow/token"}, httpsPort = 0, port = 0)
public class BoursoramaPaymentProviderV3InitiatePaymentWithMalformedAuthorizationUrlIntegrationTest {
    ...
    public void shouldReturnLoginUrlAndStateResponseWithProperLoginAndStateForInitiatePaymentWithCorrectData(SepaPaymentProvider paymentProviderUnderTest) throws JsonProcessingException {
        ...
        // then
        assertThat(loginUrlAndStateDTO.getLoginUrl()).isEqualTo("https://clients.boursorama.com/feature-redirect?featureId=customer.accounts_cashtransfer_prebuilt_transfer_form&params%5BresourceId%5D=83f9730518ee4bdfa1b024d1642c83c2");
