...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/argenta/ais-1.5/fetch-data-accounts-http500"}, httpsPort = 0, port = 0)
class ArgentaGroupDataProviderHttp500OnGetAccountsIntegrationTest {
    ...
    @Test
    void shouldThrowProviderHttpStatusExceptionWhenAccountsEndpointRespondWith500() throws IOException, URISyntaxException {
        // given
        ...
        // then
        assertThatThrownBy(throwingCallable).isExactlyInstanceOf(ProviderHttpStatusException.class)
