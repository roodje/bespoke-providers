...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/argenta/ais-1.5/fetch-data-accounts-http400"}, httpsPort = 0, port = 0)
class ArgentaGroupDataProviderHttp400OnGetAccountsIntegrationTest {
    ...
    @Test
    void shouldThrowProviderHttpStatusExceptionWhenAccountsEndpointRespondWith400() throws IOException, URISyntaxException {
        // given
