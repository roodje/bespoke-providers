...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/argenta/ais-1.5/fetch-data-accounts-http403"}, httpsPort = 0, port = 0)
class ArgentaGroupDataProviderHttp403OnGetAccountsIntegrationTest {
    ...
    @Test
    void shouldThrowTokenInvalidExceptionWhenAccountsEndpointRespondWith403() throws IOException, URISyntaxException {
        // given
