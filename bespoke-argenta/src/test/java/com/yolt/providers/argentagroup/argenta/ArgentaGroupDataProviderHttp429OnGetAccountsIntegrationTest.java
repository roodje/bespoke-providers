...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/argenta/ais-1.5/fetch-data-accounts-http429"}, httpsPort = 0, port = 0)
class ArgentaGroupDataProviderHttp429OnGetAccountsIntegrationTest {
    ...
    @Test
    void shouldThrowBackPressureRequestExceptionWhenAccountsEndpointRespondWith429() throws IOException, URISyntaxException {
        // given
        ...
        // then
        assertThatThrownBy(throwingCallable).isExactlyInstanceOf(BackPressureRequestException.class)
                .hasMessage("Too many request without PSU IP ADDRESS has been made HTTP: 429");
    }
