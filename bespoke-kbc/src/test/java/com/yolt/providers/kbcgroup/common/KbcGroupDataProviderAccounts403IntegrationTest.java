...
@AutoConfigureWireMock(stubs = "classpath:/mappings/kbcgroup/2.0.6/ais/v1/accounts_403/", httpsPort = 0, port = 0)
@ActiveProfiles("kbcgroup")
class KbcGroupDataProviderAccounts403IntegrationTest {
    ...
    void shouldThrowTokenInvalidExceptionWhen403IsReturnedFromAccountsEndpoint(KbcGroupDataProvider providerUnderTest) {
        // given
