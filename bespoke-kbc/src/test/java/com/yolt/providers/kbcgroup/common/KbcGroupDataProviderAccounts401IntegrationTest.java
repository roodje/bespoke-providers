...
@AutoConfigureWireMock(stubs = "classpath:/mappings/kbcgroup/2.0.6/ais/v1/accounts_401/", httpsPort = 0, port = 0)
@ActiveProfiles("kbcgroup")
class KbcGroupDataProviderAccounts401IntegrationTest {
    ...
    void shouldThrowTokenInvalidExceptionWhen401IsReturnedFromAccountsEndpoint(KbcGroupDataProvider providerUnderTest) {
        // given
        ...
        // when
        assertThatThrownBy(() -> providerUnderTest.fetchData(urlFetchDataRequest)).isInstanceOf(TokenInvalidException.class);
    }
