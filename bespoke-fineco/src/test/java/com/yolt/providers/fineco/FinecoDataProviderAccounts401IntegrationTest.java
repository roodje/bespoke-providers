...
/**
 * This test contains case when request to get accounts returned 401 - Unauthorized.
...
@AutoConfigureWireMock(stubs = "classpath:/mappings/ais/accounts-401", httpsPort = 0, port = 0)
@ActiveProfiles("fineco")
public class FinecoDataProviderAccounts401IntegrationTest {
