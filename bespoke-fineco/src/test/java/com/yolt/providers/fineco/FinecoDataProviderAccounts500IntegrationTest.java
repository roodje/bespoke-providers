...
/**
 * This test contains case when request to get accounts returned 500 - Internal Server Error.
...
@AutoConfigureWireMock(stubs = "classpath:/mappings/ais/accounts-500", httpsPort = 0, port = 0)
@ActiveProfiles("fineco")
public class FinecoDataProviderAccounts500IntegrationTest {
    ...
    void shouldThrowProviderFetchDataExceptionWhenAccountsRequestFail(UrlDataProvider providerUnderTest) {
        // given
