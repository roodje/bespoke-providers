...
@Service
public class FinecoDetailsProvider implements AisDetailsProvider, PisDetailsProvider {

    public static final String SITE_ID = "6b1e2a35-f296-44dd-9227-b5c9013efd2f";
    public static final String PROVIDER_KEY = "FINECO";
    public static final String PROVIDER_DISPLAY_NAME = "Fineco Bank";

    private static final List<AisSiteDetails> AIS_SITE_DETAILS = List.of(
            site(SITE_ID, PROVIDER_DISPLAY_NAME, PROVIDER_KEY, DIRECT_CONNECTION, of(STATE), of(CURRENT_ACCOUNT, CREDIT_CARD), of(IT))
