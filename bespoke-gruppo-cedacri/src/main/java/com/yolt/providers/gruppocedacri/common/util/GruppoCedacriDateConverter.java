package com.yolt.providers.gruppocedacri.common.util;
...
public class GruppoCedacriDateConverter {
    ...
    public ZonedDateTime determineTransactionDateTime(String bookingDateTime) {
