 ...
 * Covered flows:
 * - acquiring consent id
 * <p>
 */
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@SpringBootTest(classes = GruppoCedacriTestApp.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
@AutoConfigureWireMock(stubs = "classpath:/stubs/gruppocedacri/ais/consents-401", port = 0, httpsPort = 0)
@ActiveProfiles("gruppocedacri")
public class GruppoCedacriDataProviderV1Consents401IntegrationTest {
    ...
    void shouldThrowGetLoginInfoUrlFailedExceptionWhen401WasReturned(UrlDataProvider dataProvider) {
        // given
        ...
        // then
        assertThatExceptionOfType(GetLoginInfoUrlFailedException.class).isThrownBy(throwingCallable).withMessage("Error occurred during consent creation");
    }
}