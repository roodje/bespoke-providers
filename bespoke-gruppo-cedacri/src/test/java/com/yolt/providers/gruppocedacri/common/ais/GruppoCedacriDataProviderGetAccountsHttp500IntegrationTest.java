...
@AutoConfigureWireMock(stubs = "classpath:/stubs/gruppocedacri/ais/get-accounts-500/", httpsPort = 0, port = 0)
@ActiveProfiles("gruppocedacri")
class GruppoCedacriDataProviderGetAccountsHttp500IntegrationTest {
    ...
    void shouldThrowProviderFetchDataExceptionOnHttp500(UrlDataProvider dataProvider) throws JsonProcessingException {
        // given
