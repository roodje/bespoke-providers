...
@AutoConfigureWireMock(stubs = "classpath:/stubs/pis/status-payment-http4xx", httpsPort = 0, port = 0)
public class KnabPaymentProviderV2PaymentStatus4xxIntegrationTest {
    ...
    public void shouldReturnSepaPaymentStatusResponseDTOWithEmptyPaymentIdAndPecMetadataWithProperStatusesForGetPaymentStatusWhen4xxError(final SepaPaymentProvider subject) {
        // given
