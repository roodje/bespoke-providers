...
@AutoConfigureWireMock(stubs = "classpath:/stubs/pis/initiate-payment-http4xx", httpsPort = 0, port = 0)
public class KnabPaymentProviderV2InitiatePayment4xxIntegrationTest {
    ...
    public void shouldReturnLoginUrlAndStateDTOWithEmptyLoginUrlAndEmptyProviderStateWithProperStatusesInPecMetadataForInitiatePaymentWhen4xxError(final SepaPaymentProvider subject) {
        // given
