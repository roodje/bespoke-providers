package com.yolt.providers.knabgroup.knab.v2.sadflow.getLoginInfo.expiredtokenduringconsent;
...
@AutoConfigureWireMock(stubs = "classpath:/stubs/sadflowv2/getlogininfo/expiredtokenduringconsent", httpsPort = 0, port = 0)
class ExpiredTokenDuringConsentV2IntegrationTest {
    ...
    @Test
    void shouldThrowGetLoginInfoUrlFailedExceptionWhenTokenIsExpired() {
        // given
