...
import static com.yolt.providers.knabgroup.common.payment.PaymentEndpointResolver.INITIATE_PAYMENT_ENDPOINT;
...
class DefaultInitiatePaymentHttpRequestInvokerTest {
    ...
    private DefaultInitiatePaymentHttpRequestInvoker subject;
    ...
    @Mock
    private HttpEntity<InitiatePaymentRequestBody> requestEntity;
    ...
    void shouldReturnResponseEntityWithJsonNodeAsBodyForInvokeRequestWhenCorrectData() throws TokenInvalidException {
        ...
        subject = new DefaultInitiatePaymentHttpRequestInvoker(httpClientFactory, new DefaultPisHttpClientErrorHandler(), PaymentType.SINGLE, new PaymentEndpointResolver());
