...
class KnabCreateAccessMeansHttpErrorHandlerV2Test {

    private KnabCreateAccessMeansHttpErrorHandlerV2 httpErrorHandler = new KnabCreateAccessMeansHttpErrorHandlerV2();
    ...
    @Test
    void shouldThrowGetAccessTokenFailedExceptionWhenUnauthorizedStatusIsReturned() {
        //given
        HttpStatusCodeException exception = mock(HttpStatusCodeException.class);
    ...
    @Test
    void shouldThrowGetAccessTokenFailedExceptionWhenForbiddenStatusIsReturned() {
        //given
        HttpStatusCodeException exception = mock(HttpStatusCodeException.class);
