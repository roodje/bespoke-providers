...
class DefaultStatusPaymentPreExecutionResultMapperTest {
    ...
    void shouldReturnDefaultStatusPaymentPreExecutionResultForMapWhenCorrectData() throws JsonProcessingException {
        // given
        DefaultStatusPaymentPreExecutionResultMapper subject = new DefaultStatusPaymentPreExecutionResultMapper(accessMeansProvider, "provider", objectMapper);
        Map<String, BasicAuthenticationMean> authMeans = SampleAuthenticationMeans.getSampleAuthenticationMeans();
        GetStatusRequest request = createSamplePaymentRequest(authMeans);
    ...
    private GetStatusRequest createSamplePaymentRequest(Map<String, BasicAuthenticationMean> authMeans) {
