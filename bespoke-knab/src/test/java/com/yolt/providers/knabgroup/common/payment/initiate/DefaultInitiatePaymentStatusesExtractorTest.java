...
class DefaultInitiatePaymentStatusesExtractorTest {
    ...
    private DefaultInitiatePaymentStatusesExtractor subject;
    ...
    void shouldReturnCorrectlyMappedPaymentStatusesForKnownStatusValue() {
        ...
        subject = new DefaultInitiatePaymentStatusesExtractor(statusMapper);

        // when
        PaymentStatuses result = subject.extractPaymentStatuses(new InitiatePaymentResponse(null, "transactionStatus", null), null);
