...
/**
 * This test contains flow for scenarios when 4xx error occurs during payment initiation process
...
@AutoConfigureWireMock(
        stubs = "classpath:/stubs/pis/3.0/initiate_payment_4xx",
        httpsPort = 0, port = 0)
@ActiveProfiles("cbiglobe")
public class CbiGlobeSepaPaymentProviderV3InitiatePayment4xxIntegrationTest {
    ...
    public void shouldReturnResponseWithEmptyLoginUrlAndEmptyProviderStateAndProperStatusesInPecMetadataForInitiatePaymentWhen4xxError(SepaPaymentProvider paymentProvider) {
        //given
