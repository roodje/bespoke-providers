...
/**
 * This test contains flow for scenarios when 500 error occurs during payment submission process and getting payment status
...
@AutoConfigureWireMock(
        stubs = "classpath:/stubs/pis/3.0/payment_status_500",
        httpsPort = 0, port = 0)
@ActiveProfiles("cbiglobe")
public class CbiGlobeSepaPaymentProviderV3PaymentStatus500IntegrationTest {
    ...
    public void shouldReturnResponseWithEmptyPaymentIdAndProperStatusesInPecMetadataForSubmitPaymentWhen500Error(SepaPaymentProvider paymentProvider) {
        // given
    ...
    @ParameterizedTest
    @MethodSource("getPaymentProviders")
    public void shouldThrowPaymentExecutionTechnicalExceptionForPaymentStatusWhen500Error(SepaPaymentProvider paymentProvider) {
        // given
