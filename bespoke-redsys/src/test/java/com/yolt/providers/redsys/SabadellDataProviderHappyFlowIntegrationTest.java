...
/**
 * This test contains fetch data happy flow occurring in Sabadell provider.
 * <p>
 * Disclaimer: There is only one provider {@link SabadellDataProviderV3} for this bank, so tests are not parametrized.
 * <p>
 * Covered flows:
...
class SabadellDataProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    private SabadellDataProviderV3 dataProvider;
    ...
    void shouldFetchData() throws TokenInvalidException, ProviderFetchDataException, JsonProcessingException {
        ...
        ProviderAccountDTO currentAccount1 = getCurrentAccountById(dataProviderResponse, "ES2420802795447427789873");
        assertThat(currentAccount1.getAccountId()).isEqualTo("ES2420802795447427789873");
        ...
        assertThat(currentAccount1.getAvailableBalance()).isEqualTo("1230.00");
        ...
        assertThat(currentAccount1.getTransactions()).hasSize(4);

        validateCurrentAccountTransactions(currentAccount1.getTransactions());

        // Verify Current Account without transactions
        ProviderAccountDTO currentAccount2 = getCurrentAccountById(dataProviderResponse, "ES6304872525084915317536");
        assertThat(currentAccount2.getAccountId()).isEqualTo("ES6304872525084915317536");
        ...
        assertThat(currentAccount2.getAvailableBalance()).isEqualTo("500.00");
    ...
    private void validateCurrentAccountTransactions(List<ProviderTransactionDTO> transactions) {
        ...
        assertThat(transaction1.getDescription()).isEqualTo("/DB/BSABESBB/CB/BSABESBBXXX/TXT/TRANSFERENCIA A SUMINISTROS TORRAS");

        ExtendedTransactionDTO extendedTransaction = transaction1.getExtendedTransaction();
        assertThat(extendedTransaction.getRemittanceInformationUnstructured()).isEqualTo("/DB/BSABESBB/CB/BSABESBBXXX/TXT/TRANSFERENCIA A SUMINISTROS TORRAS");
        assertThat(extendedTransaction.getRemittanceInformationStructured()).isEqualTo("factura S999999");
        ...
        assertThat(transaction2.getDescription()).isEqualTo("/DB/BSABESBB/CB/INGDESMMXXX/TXT/TRANSFERENCIA A JESSICA");
        assertThat(transaction2.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("/DB/BSABESBB/CB/INGDESMMXXX/TXT/TRANSFERENCIA A JESSICA");
        assertThat(transaction2.getExtendedTransaction().getRemittanceInformationStructured()).isEqualTo("IRPF");
        ...
        assertThat(transaction3.getDescription()).isEqualTo("/DB/BSABESBB/CB/CAIXESBBXXX/TXT/TRANSFERENCIA A JESSICA FLORES");
        assertThat(transaction3.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("/DB/BSABESBB/CB/CAIXESBBXXX/TXT/TRANSFERENCIA A JESSICA FLORES");
        assertThat(transaction3.getExtendedTransaction().getRemittanceInformationStructured()).isEqualTo("efectivo");
    }
