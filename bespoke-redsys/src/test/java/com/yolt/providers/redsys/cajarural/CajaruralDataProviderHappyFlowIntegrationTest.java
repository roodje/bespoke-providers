...
class CajaruralDataProviderHappyFlowIntegrationTest {
    ...
    private ResdysGenericStepDataProvider<CajaRuralSerializableConsentProcessData> dataProvider;
    ...
    private AccessMeansDTO createAccessMeansDTO() throws JsonProcessingException {
        return new AccessMeansDTO(
                ...
                objectMapper.writeValueAsString(
                        new SerializableConsentProcessData(
                                4,
                                new RedsysAccessMeans(createAccessMeansToken(), REDIRECT_URL, CONSENT_ID, null, Instant.MIN, new FilledInUserSiteFormValues()),
