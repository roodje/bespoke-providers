...
/**
 * This test contains fetch data happy flow occurring in LaboralKutxa provider.
 * <p>
 * Disclaimer: There is only one provider {@link LaboralKutxaDataProvider} for this bank, so tests are not parametrized.
 * <p>
 * Covered flows:
...
class LaboralKutxaDataProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    private LaboralKutxaDataProvider dataProvider;
