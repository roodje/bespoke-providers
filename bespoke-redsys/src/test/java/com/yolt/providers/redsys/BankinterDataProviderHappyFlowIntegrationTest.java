...
/**
 * This test contains fetch data happy flow occurring in Bankinter provider.
 * <p>
 * Disclaimer: There is only one provider {@link BankinterDataProviderV4} for this bank, so tests are not parametrized.
 * <p>
 * Covered flows:
...
class BankinterDataProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    private BankinterDataProviderV4 dataProvider;
    ...
    private void validateCurrentAccountTransactions(List<ProviderTransactionDTO> transactions) {
        ...
        assertThat(transaction1.getDescription()).isEqualTo("PORTO PANADEROS");

        ExtendedTransactionDTO extendedTransaction = transaction1.getExtendedTransaction();
        assertThat(extendedTransaction.getRemittanceInformationUnstructured()).isEqualTo("PORTO PANADEROS");
        ...
        assertThat(transaction2.getDescription()).isEqualTo("FCIA ARROYO ¨PEREZ");
        assertThat(transaction2.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("FCIA ARROYO ¨PEREZ");
        ...
        assertThat(transaction3.getDescription()).isEqualTo("48J2224Y8ZHQ6");
        assertThat(transaction3.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("48J2224Y8ZHQ6");
    }
