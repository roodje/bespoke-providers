...
/**
 * This test contains fetch data happy flow occurring in BBVA provider.
 * <p>
 * Disclaimer: There is only one provider {@link BBVADataProviderV3} for this bank, so tests are not parametrized.
 * <p>
 * Covered flows:
...
class BBVADataProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    private BBVADataProviderV3 dataProvider;
    ...
    private void validateCurrentAccountTransactions(List<ProviderTransactionDTO> transactions) {
        ...
        assertThat(transaction1.getDescription()).isEqualTo("TRANSFERENCIAS // TRANSFERENCIA REALIZADA // TRANSFERENCIA REALIZADA");

        ExtendedTransactionDTO extendedTransaction = transaction1.getExtendedTransaction();
        assertThat(extendedTransaction.getRemittanceInformationUnstructured()).isEqualTo("TRANSFERENCIAS // TRANSFERENCIA REALIZADA // TRANSFERENCIA REALIZADA");
        ...
        assertThat(transaction2.getDescription()).isEqualTo("ABONO DE NOMINA POR TRANSFERENCIA // INGRESO POR NÓMINA O PENSIÓN // ABONO NOMINA 12/2021");
        assertThat(transaction2.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("ABONO DE NOMINA POR TRANSFERENCIA // INGRESO POR NÓMINA O PENSIÓN // ABONO NOMINA 12/2021");
        ...
        assertThat(transaction3.getDescription()).isEqualTo("CARGO POR AMORTIZACION DE PRESTAMO/CREDITO // AMORTIZACIÓN PRÉSTAMO // CARGO POR AMORTIZACION DE PRESTAMO/CREDITO");
        assertThat(transaction3.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("CARGO POR AMORTIZACION DE PRESTAMO/CREDITO // AMORTIZACIÓN PRÉSTAMO // CARGO POR AMORTIZACION DE PRESTAMO/CREDITO");
    }
