 ...
 * is thrown {@link BackPressureRequestException})
 * <p>
...
class RedsysDataProviderAccounts429IntegrationTest {
    ...
    private static final String ACCESS_TOKEN = "0c27b6b0-9161-47b4-a452-7e36629e159f";
    ...
    void shouldThrowBackPressureRequestExceptionWhenAccountsRequestFail(UrlDataProvider provider) throws JsonProcessingException {
        // given
