...
/**
 * This test contains fetch data happy flow occurring in Kutxabank provider.
 * <p>
 * Disclaimer: There is only one provider {@link KutxabankDataProviderV1} for this bank, so tests are not parametrized.
 * <p>
 * Covered flows:
...
class KutxabankDataProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    private KutxabankDataProviderV1 dataProvider;
    ...
    void shouldFetchData() throws TokenInvalidException, ProviderFetchDataException, JsonProcessingException {
        ...
        // Verify Credit Card account with empty transactions array
        ...
        // Verify Current Account with null transactions
        ProviderAccountDTO currentAccount1 = getCurrentAccountById(dataProviderResponse, "ES2420802795447427789580");
        assertThat(currentAccount1.getAccountId()).isEqualTo("ES2420802795447427789580");
        assertThat(currentAccount1.getName()).isEqualTo("CUENTA KUTXABANK");
        assertThat(currentAccount1.getCurrency()).isEqualTo(CurrencyCode.EUR);
        assertThat(currentAccount1.getAvailableBalance()).isEqualTo("900.00");
        assertThat(currentAccount1.getCurrentBalance()).isEqualTo("900.00");
        assertThat(currentAccount1.getTransactions()).isEmpty();
    }
    ...
    private void validateCurrentAccountTransactions(List<ProviderTransactionDTO> transactions) {
        ...
        assertThat(transaction1.getDescription()).isEqualTo("Example for Remittance Information - Nómina");

        ExtendedTransactionDTO extendedTransaction = transaction1.getExtendedTransaction();
        assertThat(extendedTransaction.getRemittanceInformationUnstructured()).isEqualTo("Example for Remittance Information - Nómina");
        ...
        assertThat(transaction2.getDescription()).isEqualTo("Example for Remittance Information - ESPAÑA ");
        assertThat(transaction2.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("Example for Remittance Information - ESPAÑA ");
