...
/**
 * This test contains fetch data happy flow occurring in Openbank provider.
 * <p>
 * Disclaimer: There is only one provider {@link OpenbankDataProviderV2} for this bank, so tests are not parametrized.
 * <p>
 * Covered flows:
...
class OpenbankDataProviderV2HappyFlowIntegrationTest {
    ...
    @Autowired
    private OpenbankDataProviderV2 dataProvider;
    ...
    void shouldFetchData() throws TokenInvalidException, ProviderFetchDataException, JsonProcessingException {
        ...
        ProviderAccountDTO currentAccount = getCurrentAccountById(dataProviderResponse, "2843001");
        assertThat(currentAccount.getAccountId()).isEqualTo("2843001");
        assertThat(currentAccount.getName()).isEqualTo("Juan Carlos");
        ...
        ProviderAccountDTO creditCardAccount = getCurrentAccountById(dataProviderResponse, "2843002");
        assertThat(creditCardAccount.getAccountId()).isEqualTo("2843002");
        assertThat(creditCardAccount.getName()).isEqualTo("Juan Carlos");
    ...
    private void validateCurrentAccountTransactions(List<ProviderTransactionDTO> transactions) {
        ...
        assertThat(transaction1.getDescription()).isEqualTo("TRANSFERENCIA A FAVOR DE Juan");

        ExtendedTransactionDTO extendedTransaction = transaction1.getExtendedTransaction();
        assertThat(extendedTransaction.getRemittanceInformationUnstructured()).isEqualTo("TRANSFERENCIA A FAVOR DE Juan");
        ...
        assertThat(transaction2.getDescription()).isEqualTo("TRANSFERENCIA DE BANK EN ESPANA");
        assertThat(transaction2.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("TRANSFERENCIA DE BANK EN ESPANA");
        ...
        assertThat(transaction3.getDescription()).isEqualTo("TRANSFERENCIA A FAVOR DE Juan");
        assertThat(transaction3.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("TRANSFERENCIA A FAVOR DE Juan");
    }
