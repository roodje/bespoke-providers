 ...
 * This means that there is a mistake in our request, thus we can't map such account (so throw {@link ProviderHttpStatusException})
 * <p>
...
class RedsysDataProviderAccounts400IntegrationTest {
    ...
    void shouldThrowProviderHttpStatusExceptionWhenAccountsRequestFail(UrlDataProvider provider) throws JsonProcessingException {
        // given
