...
/**
 * This test contains fetch data happy flow occurring in Santander provider.
 * <p>
 * Disclaimer: There is only one provider {@link SantanderESDataProviderV3} for this bank, so tests are not parametrized.
 * <p>
 * Covered flows:
...
class SantanderESDataProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    private SantanderESDataProviderV3 dataProvider;
    ...
    private void validateCurrentAccountTransactions(List<ProviderTransactionDTO> transactions) {
        ...
        assertThat(transaction1.getDateTime()).isEqualTo("2017-10-27T00:00+02:00[Europe/Madrid]");
        ...
        assertThat(transaction1.getDescription()).isEqualTo("RECIBO 7 ESTRELLAS EDUCACION Y OCIO S.L. Nº RECIBO 0000 0000 000 BBLJJBN REF. MANDATO 200092309, DE");

        ExtendedTransactionDTO extendedTransaction = transaction1.getExtendedTransaction();
        assertThat(extendedTransaction.getRemittanceInformationUnstructured()).isEqualTo("RECIBO 7 ESTRELLAS EDUCACION Y OCIO S.L. Nº RECIBO 0000 0000 000 BBLJJBN REF. MANDATO 200092309, DE");
        assertThat(extendedTransaction.getBookingDate()).isEqualTo("2017-10-27T00:00+02:00[Europe/Madrid]");
        assertThat(extendedTransaction.getValueDate()).isEqualTo("2017-10-26T00:00+02:00[Europe/Madrid]");
        ...
        assertThat(transaction2.getDescription()).isEqualTo("COMPRA ImPASTA, Madrid, TARJETA 5163830076000000 , COMISION 0,00");
        assertThat(transaction2.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("COMPRA ImPASTA, Madrid, TARJETA 5163830076000000 , COMISION 0,00");
        ...
        assertThat(transaction3.getDescription()).isEqualTo("TRANSACCION CONTACTLESS EN ALDI RIVAS TDA, SANCHEZ-VACIAMA, TARJ. :*171274");
        assertThat(transaction3.getExtendedTransaction().getRemittanceInformationUnstructured()).isEqualTo("TRANSACCION CONTACTLESS EN ALDI RIVAS TDA, SANCHEZ-VACIAMA, TARJ. :*171274");
    }
