...
/**
 * This test contains fetch data happy flow occurring in Evo provider.
 * <p>
 * Disclaimer: There is only one provider {@link EvoDataProvider} for this bank, so tests are not parametrized.
 * <p>
 * Covered flows:
...
class EvoDataProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    private EvoDataProvider dataProvider;
    ...
    void shouldFetchData() throws TokenInvalidException, ProviderFetchDataException, JsonProcessingException {
        ...
        assertThat(currentAccount1.getExtendedAccount().getBalances().get(0).getLastChangeDateTime())
                .isEqualTo(ZonedDateTime.of(2021, 7, 27, 0, 0, 0, 0, ZoneId.of("Europe/Madrid")));
        assertThat(currentAccount1.getExtendedAccount().getBalances().get(0).getReferenceDate())
                .isEqualTo(ZonedDateTime.of(2021, 7, 29, 0, 0, 0, 0, ZoneId.of("Europe/Madrid")));
