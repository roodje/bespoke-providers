...
@Configuration
public class OpenbankBeanConfig {
    ...
    @Bean
    public OpenbankDataProviderV2 getOpenbankDataProvider(final OpenbankProperties properties,
        ...
        return new OpenbankDataProviderV2(properties, authorizationService, fetchDataService, mapper, clock);
    }

    private RedsysAuthorizationService getAuthorizationService(final ObjectMapper objectMapper,
                                                               final OpenbankProperties properties) {
