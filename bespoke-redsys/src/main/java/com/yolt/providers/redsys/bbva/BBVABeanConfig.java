...
public class BBVABeanConfig {
    ...
    @Bean
    public BBVADataProviderV3 getBBVADataProvider(final BBVAProperties properties,
        ...
        return new BBVADataProviderV3(properties, authorizationService, fetchDataService, mapper, clock);
    }

    private RedsysAuthorizationService getAuthorizationService(final ObjectMapper objectMapper,
                                                              final BBVAProperties properties) {
