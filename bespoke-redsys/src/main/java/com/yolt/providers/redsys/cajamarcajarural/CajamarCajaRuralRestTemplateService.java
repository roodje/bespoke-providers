...
public class CajamarCajaRuralRestTemplateService extends RedsysRestTemplateService {

    protected final ObjectMapper objectMapper;
    protected final RedsysBaseProperties properties;

    public CajamarCajaRuralRestTemplateService(final ObjectMapper objectMapper, final RedsysBaseProperties properties) {
    ...
    public RedsysHttpClient createHttpClient(final RedsysAuthenticationMeans authenticationMeans,
        ...
        return new CajamarCajaRuralHttpClient(restTemplate);
    }
}
