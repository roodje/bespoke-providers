...
public class KutxabankDataProviderV1 extends RedsysDataProviderV2 {
    public static final String PROVIDER_IDENTIFIER = "KUTXABANK";
    public static final String PROVIDER_IDENTIFIER_NAME = "Kutxabank";

    public KutxabankDataProviderV1(final KutxabankProperties properties,
