...
public class HsmEidasUtils {
    ...
    public static KeyRequirements getKeyRequirements(final String keyIdName, final String certificateName) {
        return new KeyRequirements(getKeyRequirements(), keyIdName, certificateName);
    }
