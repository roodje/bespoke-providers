...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/consorsbankgroup/ais-1.3/accounts-500"}, httpsPort = 0, port = 0)
class ConsorsbankGroupDataProviderAccountsHttp500IntegrationTest {

    private static final String CONSENT_EXTERNAL_ID = "http500";
    ...
    @Test
    public void shouldThrowProviderHttpStatusExceptionWhenBankRespondWithServerError() throws IOException, URISyntaxException {
        // given
        ...
        // then
        Assertions.assertThatThrownBy(throwingCallable).isExactlyInstanceOf(ProviderHttpStatusException.class)
                .hasMessage("Something went wrong on bank side: HTTP 500");
    }
