...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/consorsbankgroup/ais-1.3/accounts-consent-revoked"}, httpsPort = 0, port = 0)
class ConsorsbankGroupDataProviderRevokedConsentIntegrationTest {

    private static final String CONSENT_EXTERNAL_ID = "consentRevoked";
    ...
    @Test
    public void shouldThrowTokenInvalidExceptionWhenFetchingTheDataWithUserRevokedConsent() throws IOException, URISyntaxException {
        // given
