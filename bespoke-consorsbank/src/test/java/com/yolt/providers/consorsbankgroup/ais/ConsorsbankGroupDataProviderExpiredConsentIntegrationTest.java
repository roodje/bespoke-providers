...
@AutoConfigureWireMock(stubs = {"classpath:/stubs/consorsbankgroup/ais-1.3/accounts-consent-expired"}, httpsPort = 0, port = 0)
class ConsorsbankGroupDataProviderExpiredConsentIntegrationTest {

    private static final String CONSENT_EXTERNAL_ID = "consentExpired";
