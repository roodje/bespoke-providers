...
public class NutmegPKCETest {
    ...
    @Test
    public void createRandomS256() {
        OAuth2ProofKeyCodeExchange oAuth2ProofKeyCodeExchange = NutmegPKCE.createRandomS256(RFC_RANDOM_BYTES);
