...
public class StarlingBankPisAuthorizationUrlParametersProducerTest {
    ...
    @InjectMocks
    private StarlingBankPisAuthorizationUrlParametersProducer authorizationUrlParametersProducer;
    ...
    void shouldReturnValidListOfAuthorizationUrlParametersForCorrectData() {
        ...
        assertThat(aisAuthorizationUrlParametersList.toSingleValueMap().get(SCOPE)).isEqualTo(PAYMENT_SCOPE);
    }
}