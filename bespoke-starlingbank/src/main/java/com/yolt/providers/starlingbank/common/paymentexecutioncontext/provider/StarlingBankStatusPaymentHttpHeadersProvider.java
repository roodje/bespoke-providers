...
public class StarlingBankStatusPaymentHttpHeadersProvider implements PaymentExecutionHttpHeadersProvider<StarlingBankSubmitAndStatusPaymentExecutionContextPreExecutionResult, Object> {

    private final Clock clock;

    @Override
    public HttpHeaders provideHttpHeaders(StarlingBankSubmitAndStatusPaymentExecutionContextPreExecutionResult starlingBankSubmitPaymentExecutionContextPreExecutionResult, Object unused) throws PaymentExecutionTechnicalException {
