...
class DeutscheBankEsDataProviderHappyFlowIntegrationTest {
    ...
    @Autowired
    private DeutscheBankEsDataProviderV1 dataProvider;
    ...
    void shouldReturnFormStepWithUserIDField() {
        ...
        assertThat(branchNumber.getId()).isEqualTo("username");
        assertThat(branchNumber.getDisplayName()).isEqualTo("Username (self-defined or unique 2 to 59 alphanumeric characters)");
    ...
    private FilledInUserSiteFormValues createFilledInUserSiteFormValues() {
        ...
        valueMap.put("username", "custom-username");
