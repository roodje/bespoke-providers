...
public class DeutscheBankGroupFetchAccountsWithoutBalancesStrategy implements DeutscheBankGroupFetchAccountsStrategy {
    ...
    public List<Account> fetchAccounts(DeutscheBankGroupHttpClient httpClient,
        ...
        try {
            AccountsResponse response = httpClient.getAccounts(ACCOUNTS_ENDPOINT, providerState, request.getPsuIpAddress());
