...
/**
 * This test class contains a test when the bank's API returns HTTP-429 status code on /balances endpoint.
 */
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@SpringBootTest(classes = TestApp.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
@ActiveProfiles("direkt1822group")
@AutoConfigureWireMock(stubs = "classpath:/mappings/direkt1822group/ais/balances-429", httpsPort = 0, port = 0)
class Direkt1822GroupDataProvider429IntegrationTest {
    ...
    public void shouldSuccessfullyFetchData(Direkt1822GroupDataProvider dataProvider) throws TokenInvalidException, ProviderFetchDataException {
        ...
        // when
        ThrowableAssert.ThrowingCallable throwingCallable = () -> dataProvider.fetchData(urlFetchData);
