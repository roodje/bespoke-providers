...
@AutoConfigureWireMock(stubs = "classpath:/mappings/direkt1822group/ais/accounts-500", httpsPort = 0, port = 0)
class Direkt1822GroupDataProvider500IntegrationTest {
    ...
    public void shouldThrowProviderHttpStatusExceptionOnHttp500(Direkt1822GroupDataProvider dataProvider) {
        //given
