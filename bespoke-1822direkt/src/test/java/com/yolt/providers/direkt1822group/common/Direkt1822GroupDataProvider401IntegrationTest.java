...
@AutoConfigureWireMock(stubs = "classpath:/mappings/direkt1822group/ais/accounts-401", httpsPort = 0, port = 0)
class Direkt1822GroupDataProvider401IntegrationTest {
    ...
    public void shouldThrowTokenInvalidExceptionOnHttp401(Direkt1822GroupDataProvider dataProvider) {
        //given
