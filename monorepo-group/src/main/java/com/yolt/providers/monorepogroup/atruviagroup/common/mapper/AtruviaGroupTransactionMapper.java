...
import com.yolt.providers.monorepogroup.atruviagroup.common.dto.external.Transaction;
...
public class AtruviaGroupTransactionMapper {
    ...
    public List<ProviderTransactionDTO> mapProviderTransactionsDTO(List<Transaction> transactions) {
        ...
        return transactions.stream()
                .map(this::mapProviderTransactionDTO)
                .toList();
    }
